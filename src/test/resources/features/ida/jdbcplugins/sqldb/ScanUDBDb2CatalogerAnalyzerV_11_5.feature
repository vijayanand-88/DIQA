@MLP-28411
Feature:Verification of Scan UDB Analyzer using DB2 database and plugin validation (11.5 Version)
...
#      | IDC         | TestSystemUser | application/json |       |       | Get  | settings/credentials/UDB_EDIBusCredentials  |                                                            | 200           |                  |          |
  ...
  Scenario:Add valid Datasource for ScanUDB
    Given Execute REST API with following parameters
      ...
      |                  | raw   | false | Get  | settings/analyzers/UDBDataSource |                                                       | 200           | UDBDataSource    |          |
 ...
 ################################## ************************************* ##############################
  ...
  Scenario: Create Table in DB2
    Given user connects to the database and performs the following operation
      ...
      | DB2_11_5           | EXECUTEQUERY | json/IDA.json | db2Queries_11_5 | createConstraintTable     |
      | DB2_11_5           | EXECUTEQUERY | json/IDA.json | db2Queries_11_5 | createEmptyTimeStampTable |
  ...
  Scenario: Create Table and insert value for data sampling
    Given user connects to the database and performs the following operation
      | databaseConnection | Operation    | queryPath     | queryPage       | queryField    |
      | DB2_11_5           | EXECUTEQUERY | json/IDA.json | db2Queries_11_5 | createTable   |
      | DB2_11_5           | EXECUTEQUERY | json/IDA.json | db2Queries_11_5 | insertRecord1 |
      | DB2_11_5           | EXECUTEQUERY | json/IDA.json | db2Queries_11_5 | insertRecord2 |
      | DB2_11_5           | EXECUTEQUERY | json/IDA.json | db2Queries_11_5 | insertRecord3 |
      | DB2_11_5           | EXECUTEQUERY | json/IDA.json | db2Queries_11_5 | insertRecord4 |
  ...
  Scenario: Create table for Timestamp verification
    Given user connects to the database and performs the following operation
      | databaseConnection | Operation    | queryPath     | queryPage       | queryField            |
      | DB2_11_5           | EXECUTEQUERY | json/IDA.json | db2Queries_11_5 | createTimeStampTable  |
      | DB2_11_5           | EXECUTEQUERY | json/IDA.json | db2Queries_11_5 | insertTimeStampRecord |
...
############################# ******************************************************* ################################
  ...
  Scenario:Create Cataloger and Analyser config
    Given Execute REST API with following parameters
      | Header           | Query | Param | type | url                             | body                                         | response code | response message | jsonPath |
      | application/json | raw   | false | Put  | settings/analyzers/UDBCataloger | ida/ScanUDBPayloads11_5/CatalogerConfig.json | 204           |                  |          |
      |                  |       |       | Put  | settings/analyzers/UDBAnalyzer  | ida/ScanUDBPayloads11_5/AnalyzerConfig.json  | 204           |                  |          |
  ...
  Scenario Outline:Create BusinessApplication tag
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type | url                | body                                                | response code | response message | jsonPath |
      | IDC         | TestSystemUser | application/json |       |       | Post | items/Default/root | ida/ScanUDBPayloads11_5/UDBBusinessApplication.json | 200           |                  |          |
  ...
  Scenario:SC1#Verify the breadcrumb hierarchy appears correctly when ScanUDB cataloger is ran for DB2 Database
    ...
    Then Analysis log "cataloger/UDBCataloger/DB2CatalogerWithSchemaFilterSC1/%" should display below info/error/warning
      ...
      | INFO | ANALYSIS-0073: Plugin UDBCataloger Configuration: ---  2020-09-11 10:22:27.369 INFO  - ANALYSIS-0073: Plugin UDBCataloger Configuration: name: "DB2CatalogerWithSchemaFilterSC1"  2020-09-11 10:22:27.369 INFO  - ANALYSIS-0073: Plugin UDBCataloger Configuration: pluginVersion: "LATEST"  2020-09-11 10:22:27.369 INFO  - ANALYSIS-0073: Plugin UDBCataloger Configuration: label:  2020-09-11 10:22:27.369 INFO  - ANALYSIS-0073: Plugin UDBCataloger Configuration: : "DB2CatalogerWithSchemaFilterSC1"  2020-09-11 10:22:27.369 INFO  - ANALYSIS-0073: Plugin UDBCataloger Configuration: catalogName: "Default"  2020-09-11 10:22:27.369 INFO  - ANALYSIS-0073: Plugin UDBCataloger Configuration: eventClass: null  2020-09-11 10:22:27.369 INFO  - ANALYSIS-0073: Plugin UDBCataloger Configuration: eventCondition: null  2020-09-11 10:22:27.369 INFO  - ANALYSIS-0073: Plugin UDBCataloger Configuration: nodeCondition: "name==\"LocalNode\""  2020-09-11 10:22:27.369 INFO  - ANALYSIS-0073: Plugin UDBCataloger Configuration: maxWorkSize: 100  2020-09-11 10:22:27.369 INFO  - ANALYSIS-0073: Plugin UDBCataloger Configuration: tags:  2020-09-11 10:22:27.369 INFO  - ANALYSIS-0073: Plugin UDBCataloger Configuration: - "SC1UDB"  2020-09-11 10:22:27.369 INFO  - ANALYSIS-0073: Plugin UDBCataloger Configuration: pluginType: "cataloger"  2020-09-11 10:22:27.369 INFO  - ANALYSIS-0073: Plugin UDBCataloger Configuration: dataSource: "UDBDataSource"  2020-09-11 10:22:27.369 INFO  - ANALYSIS-0073: Plugin UDBCataloger Configuration: credential: "UDB_Credentials"  2020-09-11 10:22:27.369 INFO  - ANALYSIS-0073: Plugin UDBCataloger Configuration: businessApplicationName: "UDB_BA"  2020-09-11 10:22:27.369 INFO  - ANALYSIS-0073: Plugin UDBCataloger Configuration: dryRun: false  2020-09-11 10:22:27.369 INFO  - ANALYSIS-0073: Plugin UDBCataloger Configuration: schedule: null  2020-09-11 10:22:27.369 INFO  - ANALYSIS-0073: Plugin UDBCataloger Configuration: filter: null  2020-09-11 10:22:27.369 INFO  - ANALYSIS-0073: Plugin UDBCataloger Configuration: pluginName: "UDBCataloger"  2020-09-11 10:22:27.369 INFO  - ANALYSIS-0073: Plugin UDBCataloger Configuration: schemas:  2020-09-11 10:22:27.369 INFO  - ANALYSIS-0073: Plugin UDBCataloger Configuration: - schema: "UDBTEST1"  2020-09-11 10:22:27.369 INFO  - ANALYSIS-0073: Plugin UDBCataloger Configuration: tables: []  2020-09-11 10:22:27.369 INFO  - ANALYSIS-0073: Plugin UDBCataloger Configuration: arguments: []  2020-09-11 10:22:27.369 INFO  - ANALYSIS-0073: Plugin UDBCataloger Configuration: type: "Cataloger" | ANALYSIS-0073 | UDBCataloger |                |
  ...
  Scenario:SC1#Verify the technology tags got assigned to all DB2 database items like Cluster,Service,Database...etc
    ...
    Then user "verify tag item presence" of technology tags for the below Type and file names
      ...
      | Default     | Column         | Metadata Type | SC1UDB,DB2,UDB_BA | POSTAL_CODE   | SC1UDB  |
      | Default     | Table          | Metadata Type | SC1UDB,DB2,UDB_BA | TABLE_PRIMARY | SC1UDB  |
      | Default     | Constraint     | Metadata Type | SC1UDB,DB2,UDB_BA | CKP           | SC1UDB  |
      | Default     | Tablespace     | Metadata Type | SC1UDB,DB2,UDB_BA | USERSPACE1    | SC1UDB  |
      | Default     | Index          | Metadata Type | SC1UDB,DB2,UDB_BA | CKP           | SC1UDB  |
      | Default     | Bufferpool     | Metadata Type | SC1UDB,DB2,UDB_BA | IBMDEFAULTBP  | SC1UDB  |
      | Default     | User           | Metadata Type | SC1UDB,DB2,UDB_BA | PUBLIC        | SC1UDB  |
      | Default     | PartitionGroup | Metadata Type | SC1UDB,DB2,UDB_BA | IBMCATGROUP   | SC1UDB  |
      | Default     | Cluster        | Metadata Type | SC1UDB,DB2,UDB_BA | diqdb211501v  | SC1UDB  |
      | Default     | Database       | Metadata Type | SC1UDB,DB2,UDB_BA | SAMPLE        | SC1UDB  |
      | Default     | Schema         | Metadata Type | SC1UDB,DB2,UDB_BA | UDBTEST1      | SC1UDB  |
      | Default     | Service        | Metadata Type | SC1UDB,DB2,UDB_BA | DB2:50000     | SC1UDB  |
      | Default     | StorageGroup   | Metadata Type | SC1UDB,DB2,UDB_BA | IBMSTOGROUP   | SC1UDB  |
...
#      | AP-DATA      | DDUDB       | 1.0                | (XNAME * *  ~/ @*DB2≫DEFAULT≫DWR_RDB_DB_SYSTEM≫@* ),AND,( TYPE = DWR_IDC )     |
  ...
  Scenario:Add internalnode Datasource for ScanUDB
    Given Execute REST API with following parameters
      | Header           | Query | Param | type | url                              | body                                                              | response code | response message | jsonPath |
      | application/json | raw   | false | Put  | settings/analyzers/UDBDataSource | ida/ScanUDBPayloads11_5/DataSource/UDBDataSourceInternalNode.json | 204           |                  |          |
      |                  |       |       | Get  | settings/analyzers/UDBDataSource |                                                                   | 200           | UDBDataSource    |          |

  #7208147# #7208148#
  @webtest @jdbc @MLP-28411
  ...
  Scenario:SC3#Verify the technology tags and PII tags got assigned
    ...
    Then user "verify tag item presence" of technology tags for the below Type and file names
      | catalogName | name   | facet         | Tag        | fileName | userTag |
      | Default     | Column | Metadata Type | SC2UDB,DB2 | STATE    | SC2UDB  |
  ...
  Scenario:SC12#_Add Invalid Datasource for ScanUDB
    Given Execute REST API with following parameters
      | Header           | Query | Param | type | url                              | body                                                         | response code | response message | jsonPath |
      | application/json | raw   | false | Put  | settings/analyzers/UDBDataSource | ida/ScanUDBPayloads11_5/DataSource/UDBInvalidDataSource.json | 204           |                  |          |
      |                  |       |       | Get  | settings/analyzers/UDBDataSource |                                                              | 200           | UDBDataSource    |          |
  ...
  Scenario:SC17#_Add Oracle Datasource for ScanUDB
    Given Execute REST API with following parameters
      | Header           | Query | Param | type | url                              | body                                                     | response code | response message | jsonPath |
      | application/json | raw   | false | Put  | settings/analyzers/UDBDataSource | ida/ScanUDBPayloads11_5/DataSource/OracleDataSource.json | 204           |                  |          |
      |                  |       |       | Get  | settings/analyzers/UDBDataSource |                                                          | 200           | UDBDataSource    |          |
  ...
  Scenario:SC18#_Add Postgres Datasource for ScanUDB
    Given Execute REST API with following parameters
      | Header           | Query | Param | type | url                              | body                                                       | response code | response message | jsonPath |
      | application/json | raw   | false | Put  | settings/analyzers/UDBDataSource | ida/ScanUDBPayloads11_5/DataSource/PostgresDataSource.json | 204           |                  |          |
      |                  |       |       | Get  | settings/analyzers/UDBDataSource |                                                            | 200           | UDBDataSource    |          |
...
##############################################  Delete Config , Item ids ########################
  ...
  Scenario: Drop Table
    Given user connects to the database and performs the following operation
      ...
      | DB2_11_5           | DROP      | UDBTEST1 | TABLE_PRIMARY   |          |
      | DB2_11_5           | DROP      | UDBTEST1 | DB2_TAG_DETAILS |          |
      | DB2_11_5           | DROP      | UDBTEST1 | DB2_EMPTY       |          |
      | DB2_11_5           | DROP      | UDBTEST1 | DB2_TABLE       |          |
...
##################################################################### PII Tags - Scenarios - starts ################################################################
  ...
  Scenario Outline:SC#PII_#Add Tags for UDBCataloger
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type | url                     | body                                                                      | response code | response message | jsonPath |
      | IDC         | TestSystemUser | application/json |       |       | Put  | tags/Default/structures | ida/ScanUDBPayloads11_5/policyEngine/PluginConfiguration/PIITags_UDB.json | 200           |                  |          |
  ...
  Scenario Outline:SC#PII_1:Create UDB Plugin config and start it
    ...
    Examples:
      ...
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | policy/tagging/actions                                                        | payloads/ida/ScanUDBPayloads11_5/policyEngine/1Tags.json                                   | $.typeanddatapattern1 | 204           |                  |                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/UDBCataloger/DB2CatalogerPII                               | payloads/ida/ScanUDBPayloads11_5/policyEngine/PluginConfiguration/TagsCatalogerConfig.json | $.CatalogerConfig     | 204           |                  |                                                      |
      ...
      | IDC         | TestSystemUser | application/json | raw   | false | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/UDBCataloger/DB2CatalogerPII  |                                                                                            |                       | 200           | IDLE             | $.[?(@.configurationName=='DB2CatalogerPII')].status |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/UDBAnalyzer/UDBAnalyzerPII                                 | payloads/ida/ScanUDBPayloads11_5/policyEngine/PluginConfiguration/TagsAnalyzerConfig.json  | $.configurations      | 204           |                  |                                                      |
...
#################################################################################################################################################
  ...
  Scenario Outline:SC#PII_2:Create UDB Plugin config and start it
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                           | bodyFile                                                                                   | path                  | response code | response message | jsonPath                                             |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | policy/tagging/actions                                                        | payloads/ida/ScanUDBPayloads11_5/policyEngine/1Tags.json                                   | $.nameanddatapattern1 | 204           |                  |                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/UDBCataloger/DB2CatalogerPII                               | payloads/ida/ScanUDBPayloads11_5/policyEngine/PluginConfiguration/TagsCatalogerConfig.json | $.CatalogerConfig     | 204           |                  |                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | Get          | settings/analyzers/UDBCataloger/DB2CatalogerPII                               |                                                                                            |                       | 200           | DB2CatalogerPII  |                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/UDBCataloger/DB2CatalogerPII  |                                                                                            |                       | 200           | IDLE             | $.[?(@.configurationName=='DB2CatalogerPII')].status |
      | IDC         | TestSystemUser | application/json | raw   | false | Post         | extensions/analyzers/start/LocalNode/cataloger/UDBCataloger/DB2CatalogerPII   |                                                                                            |                       | 200           |                  |                                                      |
  ...
  Scenario Outline:SC#PII_3:Create UDB Plugin config and start it
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                           | bodyFile                                                                                   | path                   | response code | response message | jsonPath                                             |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | policy/tagging/actions                                                        | payloads/ida/ScanUDBPayloads11_5/policyEngine/1Tags.json                                   | $.datapatternandratio1 | 204           |                  |                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/UDBCataloger/DB2CatalogerPII                               | payloads/ida/ScanUDBPayloads11_5/policyEngine/PluginConfiguration/TagsCatalogerConfig.json | $.CatalogerConfig      | 204           |                  |                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | Get          | settings/analyzers/UDBCataloger/DB2CatalogerPII                               |                                                                                            |                        | 200           | DB2CatalogerPII  |                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/UDBCataloger/DB2CatalogerPII  |                                                                                            |                        | 200           | IDLE             | $.[?(@.configurationName=='DB2CatalogerPII')].status |
      | IDC         | TestSystemUser | application/json | raw   | false | Post         | extensions/analyzers/start/LocalNode/cataloger/UDBCataloger/DB2CatalogerPII   |                                                                                            |                        | 200           |                  |                                                      |
  ...
  Scenario Outline:SC#PII_4:Create UDB Plugin config and start it
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                           | bodyFile                                                                                   | path                   | response code | response message | jsonPath                                             |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | policy/tagging/actions                                                        | payloads/ida/ScanUDBPayloads11_5/policyEngine/1Tags.json                                   | $.datapatternandratio2 | 204           |                  |                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/UDBCataloger/DB2CatalogerPII                               | payloads/ida/ScanUDBPayloads11_5/policyEngine/PluginConfiguration/TagsCatalogerConfig.json | $.CatalogerConfig      | 204           |                  |                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | Get          | settings/analyzers/UDBCataloger/DB2CatalogerPII                               |                                                                                            |                        | 200           | DB2CatalogerPII  |                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/UDBCataloger/DB2CatalogerPII  |                                                                                            |                        | 200           | IDLE             | $.[?(@.configurationName=='DB2CatalogerPII')].status |
      | IDC         | TestSystemUser | application/json | raw   | false | Post         | extensions/analyzers/start/LocalNode/cataloger/UDBCataloger/DB2CatalogerPII   |                                                                                            |                        | 200           |                  |                                                      |
  ...
  Scenario Outline:SC#PII_4.1:Create UDB Plugin config and start it
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                           | bodyFile                                                                                   | path                   | response code | response message | jsonPath                                             |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | policy/tagging/actions                                                        | payloads/ida/ScanUDBPayloads11_5/policyEngine/1Tags.json                                   | $.datapatternandratio3 | 204           |                  |                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/UDBCataloger/DB2CatalogerPII                               | payloads/ida/ScanUDBPayloads11_5/policyEngine/PluginConfiguration/TagsCatalogerConfig.json | $.CatalogerConfig      | 204           |                  |                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | Get          | settings/analyzers/UDBCataloger/DB2CatalogerPII                               |                                                                                            |                        | 200           | DB2CatalogerPII  |                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/UDBCataloger/DB2CatalogerPII  |                                                                                            |                        | 200           | IDLE             | $.[?(@.configurationName=='DB2CatalogerPII')].status |
      | IDC         | TestSystemUser | application/json | raw   | false | Post         | extensions/analyzers/start/LocalNode/cataloger/UDBCataloger/DB2CatalogerPII   |                                                                                            |                        | 200           |                  |                                                      |
  ...
  Scenario Outline:SC#PII_5:Create UDB Plugin config and start it
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                           | bodyFile                                                                                   | path                           | response code | response message | jsonPath                                             |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | policy/tagging/actions                                                        | payloads/ida/ScanUDBPayloads11_5/policyEngine/1Tags.json                                   | $.namedatatypepatternandratio1 | 204           |                  |                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/UDBCataloger/DB2CatalogerPII                               | payloads/ida/ScanUDBPayloads11_5/policyEngine/PluginConfiguration/TagsCatalogerConfig.json | $.CatalogerConfig              | 204           |                  |                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | Get          | settings/analyzers/UDBCataloger/DB2CatalogerPII                               |                                                                                            |                                | 200           | DB2CatalogerPII  |                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/UDBCataloger/DB2CatalogerPII  |                                                                                            |                                | 200           | IDLE             | $.[?(@.configurationName=='DB2CatalogerPII')].status |
      | IDC         | TestSystemUser | application/json | raw   | false | Post         | extensions/analyzers/start/LocalNode/cataloger/UDBCataloger/DB2CatalogerPII   |                                                                                            |                                | 200           |                  |                                                      |
  ...
  Scenario Outline:SC#PII_6:Create UDB Plugin config and start it
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                           | bodyFile                                                                                   | path              | response code | response message | jsonPath                                             |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | policy/tagging/actions                                                        | payloads/ida/ScanUDBPayloads11_5/policyEngine/1Tags.json                                   | $.matchempty      | 204           |                  |                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/UDBCataloger/DB2CatalogerPII                               | payloads/ida/ScanUDBPayloads11_5/policyEngine/PluginConfiguration/TagsCatalogerConfig.json | $.CatalogerConfig | 204           |                  |                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | Get          | settings/analyzers/UDBCataloger/DB2CatalogerPII                               |                                                                                            |                   | 200           | DB2CatalogerPII  |                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/UDBCataloger/DB2CatalogerPII  |                                                                                            |                   | 200           | IDLE             | $.[?(@.configurationName=='DB2CatalogerPII')].status |
      | IDC         | TestSystemUser | application/json | raw   | false | Post         | extensions/analyzers/start/LocalNode/cataloger/UDBCataloger/DB2CatalogerPII   |                                                                                            |                   | 200           |                  |                                                      |
  ...
  Scenario Outline:SC#PII_7:Create UDB Plugin config and start it
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                           | bodyFile                                                                                   | path              | response code | response message | jsonPath                                             |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | policy/tagging/actions                                                        | payloads/ida/ScanUDBPayloads11_5/policyEngine/1Tags.json                                   | $.matchfullcase1  | 204           |                  |                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/UDBCataloger/DB2CatalogerPII                               | payloads/ida/ScanUDBPayloads11_5/policyEngine/PluginConfiguration/TagsCatalogerConfig.json | $.CatalogerConfig | 204           |                  |                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | Get          | settings/analyzers/UDBCataloger/DB2CatalogerPII                               |                                                                                            |                   | 200           | DB2CatalogerPII  |                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/UDBCataloger/DB2CatalogerPII  |                                                                                            |                   | 200           | IDLE             | $.[?(@.configurationName=='DB2CatalogerPII')].status |
      | IDC         | TestSystemUser | application/json | raw   | false | Post         | extensions/analyzers/start/LocalNode/cataloger/UDBCataloger/DB2CatalogerPII   |                                                                                            |                   | 200           |                  |                                                      |
  ...
  Scenario Outline:SC#PII_8:Create UDB Plugin config and start it
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                           | bodyFile                                                                                   | path              | response code | response message | jsonPath                                             |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | policy/tagging/actions                                                        | payloads/ida/ScanUDBPayloads11_5/policyEngine/1Tags.json                                   | $.matchfullcase2  | 204           |                  |                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/UDBCataloger/DB2CatalogerPII                               | payloads/ida/ScanUDBPayloads11_5/policyEngine/PluginConfiguration/TagsCatalogerConfig.json | $.CatalogerConfig | 204           |                  |                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | Get          | settings/analyzers/UDBCataloger/DB2CatalogerPII                               |                                                                                            |                   | 200           | DB2CatalogerPII  |                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/UDBCataloger/DB2CatalogerPII  |                                                                                            |                   | 200           | IDLE             | $.[?(@.configurationName=='DB2CatalogerPII')].status |
      | IDC         | TestSystemUser | application/json | raw   | false | Post         | extensions/analyzers/start/LocalNode/cataloger/UDBCataloger/DB2CatalogerPII   |                                                                                            |                   | 200           |                  |                                                      |
...
##################################################################### PII Tags - Scenarios - END ################################################################
  ...
  Scenario:PII_Delete Configurations
    Given Execute REST API with following parameters
      | Header           | Query | Param | type   | url                                  | body | response code | response message | jsonPath |
      | application/json | raw d  | false | Delete | settings/credentials/UDB_Credentials |      | 200           |                  |          |
      |                  |       |       | Delete | settings/analyzers/UDBDataSource     |      | 204           |                  |          |
      |                  |       |       | Delete | settings/analyzers/UDBCataloger      |      | 204           |                  |          |
      |                  |       |       | Delete | settings/analyzers/UDBAnalyzer       |      | 204           |                  |          |
