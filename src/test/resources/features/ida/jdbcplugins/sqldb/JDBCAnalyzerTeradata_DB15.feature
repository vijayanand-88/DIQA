Feature:Verification of JDBC Analyzer using Teradata database Version 15 and plugin validation
  ...
  Scenario: SC#1-Create User in TeradataDatabase
    Given user connects to the database and performs the following operation
      ...
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | createUserInTeradataDB |

  @jdbc
  Scenario: SC#1-Create Database in TeradataDatabase
    Given user connects to the database and performs the following operation
      | databaseConnection | Operation    | queryPath     | queryPage       | queryField         |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | createDBinTeradata |

  @jdbc
  Scenario: SC#1-Create User permission in TeradataDatabase
    Given user connects to the database and performs the following operation
      | databaseConnection | Operation    | queryPath     | queryPage       | queryField          |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | grantUserPermission |

  @jdbc
  Scenario: SC#1-Create Table in Teradata
    Given user connects to the database and performs the following operation
      | databaseConnection | Operation    | queryPath     | queryPage       | queryField                |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | createConstraintTable     |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | createEmptyTimeStampTable |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | createUniqueConstraint    |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | createPrimaryConstraint   |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | createForeignConstraint   |

  @jdbc
  Scenario: SC#1-Create Table and insert value for data sampling
    Given user connects to the database and performs the following operation
      | databaseConnection | Operation    | queryPath     | queryPage       | queryField    |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | createTable   |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord1 |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord2 |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord3 |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord4 |
  ...
  Scenario: SC#1-Create table for Timestamp verification
    Given user connects to the database and performs the following operation
      | databaseConnection | Operation    | queryPath     | queryPage       | queryField            |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | createTimeStampTable  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertTimeStampRecord |
  ...
  Scenario Outline: SC#1: Set the credential and DataSource for Teradata
    ...
    Examples:
      ...
      | IDC         | TestSystemUser | application/json | raw   | false | Put  | settings/credentials/TeradataCredentials                                                | ida/jdbcAnalyzerPayloads/Teradata_V15/Credentials/TeradataCredentials.json                    | 200           |                                         |          |
      | IDC         | TestSystemUser | application/json | raw   | false | Get  | settings/credentials/TeradataCredentials                                                |                                                                                               | 200           |                                         |          |
      | IDC         | TestSystemUser | application/json | raw   | false | Put  | settings/credentials/TeradataInvalidCredentials                                         | ida/jdbcAnalyzerPayloads/Teradata_V15/Credentials/TeradataInvalidCredentials.json             | 200           |                                         |          |
      | IDC         | TestSystemUser | application/json | raw   | false | Get  | settings/credentials/TeradataInvalidCredentials                                         |                                                                                               | 200           |                                         |          |
      | IDC         | TestSystemUser | application/json | raw   | false | Put  | settings/credentials/TeradataEmptyCredentials                                           | ida/jdbcAnalyzerPayloads/Teradata_V15/Credentials/TeradataEmptyCredentials.json               | 200           |                                         |          |
      | IDC         | TestSystemUser | application/json | raw   | false | Get  | settings/credentials/TeradataEmptyCredentials                                           |                                                                                               | 200           |                                         |          |
      | IDC         | TestSystemUser | application/json | raw   | false | Put  | settings/analyzers/TeradataDBDataSource/TeradataDataSource                              | ida/jdbcAnalyzerPayloads/Teradata_V15/DataSource/TeradataDataSource.json                      | 204           |                                         |          |
      ...
      | IDC         | TestSystemUser | application/json | raw   | false | Put  | settings/analyzers/TeradataDBDataSource/TeradataDataSourceInternalNode                  | ida/jdbcAnalyzerPayloads/Teradata_V15/DataSource/TeradataDataSourceWithNodeCondition.json     | 204           |                                         |          |
      ...
      | IDC         | TestSystemUser | application/json | raw   | false | Put  | settings/analyzers/TeradataDBDataSource/TeradataDataSourceWithWrongHost                 | ida/jdbcAnalyzerPayloads/Teradata_V15/DataSource/TeradataDataSourceWithInCorrectHost.json     | 204           |                                         |          |
      ...
      | IDC         | TestSystemUser | application/json | raw   | false | Put  | settings/analyzers/TeradataDBDataSource/TeradataDataSourceWithWrongBundleName           | ida/jdbcAnalyzerPayloads/Teradata_V15/DataSource/TeradataDataSourceWithWrongBundleName.json   | 204           |                                         |          |
      ...
      | IDC         | TestSystemUser | application/json | raw   | false | Put  | settings/analyzers/TeradataDBDataSource/TeradataDataSourceWithWrongDriverName           | ida/jdbcAnalyzerPayloads/Teradata_V15/DataSource/TeradataDataSourceWithWrongDriverName.json   | 204           |                                         |          |
      ...
      | IDC         | TestSystemUser | application/json | raw   | false | Put  | settings/analyzers/TeradataDBDataSource/TeradataDataSourceWithInvalidCredential         | ida/jdbcAnalyzerPayloads/Teradata_V15/DataSource/TeradataDataSourceWithInvalidCredential.json | 204           |                                         |          |
      ...
      | IDC         | TestSystemUser | application/json | raw   | false | Put  | settings/analyzers/TeradataDBDataSource/TeradataDBDataSource_TEST_DEFAULT_CONFIGURATION | ida/jdbcAnalyzerPayloads/Teradata_V15/DataSource/TeradataDataSource_DefaultConfig.json        | 204           |                                         |          |
  ...
  Scenario Outline:SC#1: Create BusinessApplication tag and run the plugin configuration
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type | url                | body                                                        | response code | response message | jsonPath |
      | IDC         | TestSystemUser | application/json |       |       | Post | items/Default/root | ida/jdbcAnalyzerPayloads/Teradata_V15/Test_BA_Teradata.json | 200           |                  |          |
  ...
  Scenario Outline: SC#3:Run teradata cataloger with dryrun as true
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                                                  | body                                                                                              | response code | response message                | jsonPath                                                             |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/TeradataDBCataloger/TeraDataCatalogerWithDryRunTrue                               | ida/jdbcAnalyzerPayloads/Teradata_V15/PluginConfiguration/sc1TeradataCatalogerWithDryRunTrue.json | 204           |                                 |                                                                      |
  ...
  Scenario Outline: SC#4:Run teradata cataloger with dryrun as false
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                                                      | body                                                                                                  | response code | response message                    | jsonPath                                                                 |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/TeradataDBCataloger/TeraDataCatalogerWithDatabaseFilter                               | ida/jdbcAnalyzerPayloads/Teradata_V15/PluginConfiguration/sc1TeradataCatalogerWithDBfilterConfig.json | 204           |                                     |                                                                          |
...
#      | SingleItemDelete | Default | bulk/EDIBus/EDIBusDynamoDB/% | Analysis |       |       |
  ...
  Scenario: SC#5:LoggingEnhancements: Verify TeradataDBCataloger collects Analysis item with proper log messages
    ...
    Then Analysis log "cataloger/TeradataDBCataloger/TeraDataCatalogerWithDatabaseFilter%" should display below info/error/warning
      ...
      | INFO | ANALYSIS-0073: Plugin TeradataDBCataloger Configuration: ---  2020-08-27 14:14:06.618 INFO  - ANALYSIS-0073: Plugin TeradataDBCataloger Configuration: name: "TeraDataCatalogerWithDatabaseFilter"  2020-08-27 14:14:06.618 INFO  - ANALYSIS-0073: Plugin TeradataDBCataloger Configuration: pluginVersion: "LATEST"  2020-08-27 14:14:06.618 INFO  - ANALYSIS-0073: Plugin TeradataDBCataloger Configuration: label:  2020-08-27 14:14:06.618 INFO  - ANALYSIS-0073: Plugin TeradataDBCataloger Configuration: : ""  2020-08-27 14:14:06.618 INFO  - ANALYSIS-0073: Plugin TeradataDBCataloger Configuration: catalogName: "Default"  2020-08-27 14:14:06.618 INFO  - ANALYSIS-0073: Plugin TeradataDBCataloger Configuration: eventClass: null  2020-08-27 14:14:06.618 INFO  - ANALYSIS-0073: Plugin TeradataDBCataloger Configuration: eventCondition: null  2020-08-27 14:14:06.618 INFO  - ANALYSIS-0073: Plugin TeradataDBCataloger Configuration: nodeCondition: "name==\"LocalNode\""  2020-08-27 14:14:06.618 INFO  - ANALYSIS-0073: Plugin TeradataDBCataloger Configuration: maxWorkSize: 100  2020-08-27 14:14:06.618 INFO  - ANALYSIS-0073: Plugin TeradataDBCataloger Configuration: tags:  2020-08-27 14:14:06.618 INFO  - ANALYSIS-0073: Plugin TeradataDBCataloger Configuration: - "SC1TeradataCatalogerWithDBfilterConfig"  2020-08-27 14:14:06.618 INFO  - ANALYSIS-0073: Plugin TeradataDBCataloger Configuration: pluginType: "cataloger"  2020-08-27 14:14:06.618 INFO  - ANALYSIS-0073: Plugin TeradataDBCataloger Configuration: dataSource: "TeradataDataSource"  2020-08-27 14:14:06.618 INFO  - ANALYSIS-0073: Plugin TeradataDBCataloger Configuration: credential: "TeradataCredentials"  2020-08-27 14:14:06.618 INFO  - ANALYSIS-0073: Plugin TeradataDBCataloger Configuration: businessApplicationName: "Test_BA_Teradata"  2020-08-27 14:14:06.619 INFO  - ANALYSIS-0073: Plugin TeradataDBCataloger Configuration: dryRun: false  2020-08-27 14:14:06.619 INFO  - ANALYSIS-0073: Plugin TeradataDBCataloger Configuration: schedule: null  2020-08-27 14:14:06.619 INFO  - ANALYSIS-0073: Plugin TeradataDBCataloger Configuration: filter: null  2020-08-27 14:14:06.619 INFO  - ANALYSIS-0073: Plugin TeradataDBCataloger Configuration: pluginName: "TeradataDBCataloger"  2020-08-27 14:14:06.620 INFO  - ANALYSIS-0073: Plugin TeradataDBCataloger Configuration: databaseFilter:  2020-08-27 14:14:06.620 INFO  - ANALYSIS-0073: Plugin TeradataDBCataloger Configuration: - database: "automation_test_db"  2020-08-27 14:14:06.620 INFO  - ANALYSIS-0073: Plugin TeradataDBCataloger Configuration: casesensitive: true  2020-08-27 14:14:06.620 INFO  - ANALYSIS-0073: Plugin TeradataDBCataloger Configuration: arguments: []  2020-08-27 14:14:06.620 INFO  - ANALYSIS-0073: Plugin TeradataDBCataloger Configuration: type: "Cataloger" | ANALYSIS-0073 | TeradataDBCataloger |                |
  ...
  Scenario: SC#7:Verify the Database(TeradataDB) should have the appropriate metadata information in IDC UI and Database
    ...
    Then the following metadata values should be displayed
      ...
      | Storage type      | TeradataTeradata Database 15.10.00.07 | Description |
  ...
  Scenario: SC#12-Verify the relationships shows properly between the table and constraint under relationship tab
    Given User launch browser and traverse to login page
    And user enter credentials for "System Administrator1" role
    And user enters the search text "empForeign" and clicks on search
    And user performs "facet selection" in "SC1TeradataCatalogerWithDBfilterConfig" attribute under "Tags" facets in Item Search results page
    And user performs "facet selection" in "Constraint" attribute under "Metadata Type" facets in Item Search results page
    And user performs "item click" on "empForeign" item from search results
    Then user performs click and verify in new window
  ...
  Scenario: SC#18-Verify TeradataDBCataloger collects items like Cluster, Service, Database, Table, Columns if node condition is specified in configuration.
    Given Execute REST API with following parameters
      ...
      | application/json |       |       | Put          | settings/analyzers/TeradataDBCataloger/TeradataCatalogerWithNodeCondition                                  | ida/jdbcAnalyzerPayloads/Teradata_V15/PluginConfiguration/sc3TeradataCatalogerWithNodeCondition.json | 204           |                                    |                                                                         |              |          |
  ...
  Scenario:SC#20:Verify the technology tags got assigned to all Teradata DB items like Cluster,Service,Database...etc
    ...
    Then user "verify tag item presence" of technology tags for the below Type and file names
      ...
      | Default     | Cluster    | Metadata Type | Teradata,SC3TeradataCatalogerWithNodeCondition,Test_BA_Teradata                                  | 10.33.6.190          | SC3TeradataCatalogerWithNodeCondition |
      | Default     | Service    | Metadata Type | Teradata,SC3TeradataCatalogerWithNodeCondition,Test_BA_Teradata                                  | Teradata:6666        | SC3TeradataCatalogerWithNodeCondition |
      | Default     | Database   | Metadata Type | Teradata,SC3TeradataCatalogerWithNodeCondition,Test_BA_Teradata,AnalyzeTeradataWithNodeCondition | automation_test_db   | SC3TeradataCatalogerWithNodeCondition |
  ...
  Scenario: SC#21-Verify Teradata cataloger does not collect any DB items and log throws error when the jdbc url has incorrect host
    Given Execute REST API with following parameters
      | Header           | Query | Param | type         | url                                                                                                     | body                                                                                              | response code | response message                   | jsonPath                                                                | endpointType | itemName |
      | application/json |       |       | Put          | settings/analyzers/TeradataDBCataloger/TeraDataCatalogerWithWrongHostInDS                               | ida/jdbcAnalyzerPayloads/Teradata_V15/PluginConfiguration/sc5TeradataCatalogerWithWrongURLds.json | 204           |                                    |                                                                         |              |          |
    ...
    Then Analysis log "cataloger/TeradataDBCataloger/TeraDataCatalogerWithWrongHostInDS%" should display below info/error/warning
      | type  | logValue                                     | logCode       | pluginName | removableText |
      | ERROR | Login failure for Connection to 10.33.6.1930 | ANALYSIS-0067 |            |               |
  ...
  Scenario: SC#22-Verify TeradataDBCataloger scans and collects data if Database name is provided in filters
    Given Execute REST API with following parameters
      | Header           | Query | Param | type         | url                                                                                                      | body                                                                                                  | response code | response message                    | jsonPath                                                                 | endpointType | itemName |
      | application/json |       |       | Put          | settings/analyzers/TeradataDBCataloger/TeraDataCatalogerWithDatabaseFilter                               | ida/jdbcAnalyzerPayloads/Teradata_V15/PluginConfiguration/sc1TeradataCatalogerWithDBfilterConfig.json | 204           |                                     |                                                                          |              |          |
  ...
  Scenario: SC#29-Verify JDBC cataloger scans and collects data if multiple Database names are provided in filters(Teradata DB)
    Given Execute REST API with following parameters
      | Header           | Query | Param | type         | url                                                                                                              | body                                                                                                                | response code | response message                            | jsonPath                                                                         | endpointType | itemName |
      | application/json |       |       | Put          | settings/analyzers/TeradataDBCataloger/TeradataCatalogerwithMultipleDatabaseFilter                               | ida/jdbcAnalyzerPayloads/Teradata_V15/PluginConfiguration/sc8TeradataCatalogerwithMultipleDatabaseFilterConfig.json | 204           |                                             |                                                                                  |              |          |
  ...
  Scenario: SC#30-Verify Teradata cataloger scans and collects data if non existing database name are provided in filters(Teradata DB)
    Given Execute REST API with following parameters
      | Header           | Query | Param | type         | url                                                                                                           | body                                                                                                             | response code | response message                         | jsonPath                                                                      | endpointType | itemName |
      | application/json |       |       | Put          | settings/analyzers/TeradataDBCataloger/TeradataCatalogerwithNonExistingDatabase                               | ida/jdbcAnalyzerPayloads/Teradata_V15/PluginConfiguration/sc9TeradataCatalogerwithNonExistingDatabaseConfig.json | 204           |                                          |                                                                               |              |          |
  ...
  Scenario: SC#31-Verify the error message when Configuration Bundle Name is incorrect
    Given Execute REST API with following parameters
      | Header           | Query | Param | type         | url                                                                                                           | body                                                                                                              | response code | response message                         | jsonPath                                                                      | endpointType | itemName |
      | application/json |       |       | Put          | settings/analyzers/TeradataDBCataloger/TeradataCatalogerwithIncorrectBundleName                               | ida/jdbcAnalyzerPayloads/Teradata_V15/PluginConfiguration/sc10TeradataCatalogerwithIncorrectBundleNameConfig.json | 204           |                                          |                                                                               |              |          |
  ...
  Scenario: SC#32-Verify the error message when Configuration Bundle Driver is incorrect
    Given Execute REST API with following parameters
      | Header           | Query | Param | type         | url                                                                                                             | body                                                                                                                | response code | response message                           | jsonPath                                                                        | endpointType | itemName |
      | application/json |       |       | Put          | settings/analyzers/TeradataDBCataloger/TeradataCatalogerwithIncorrectBundleDriver                               | ida/jdbcAnalyzerPayloads/Teradata_V15/PluginConfiguration/sc11TeradataCatalogerwithIncorrectBundleDriverConfig.json | 204           |                                            |                                                                                 |              |          |
  ...
  Scenario: SC#39-Start the TeradataDBCataloger without filters
    Given Execute REST API with following parameters
      | Header           | Query | Param | type         | url                                                                                                   | body                                                                                                      | response code | response message                 | jsonPath                                                              | endpointType | itemName |
      | application/json |       |       | Put          | settings/analyzers/TeradataDBCataloger/TeraDataCatalogerWithoutDBFilter                               | ida/jdbcAnalyzerPayloads/Teradata_V15/PluginConfiguration/sc18TeradataCatalogerWithoutDBfilterConfig.json | 204           |                                  |                                                                       |              |          |
  ...
  Scenario:SC#41:Verify the technology tags got assigned to all Teradata DB items like Cluster,Service,Database...etc
    ...
    Then user "verify tag item presence" of technology tags for the below Type and file names
      | catalogName | name       | facet         | Tag                                                            | fileName           | userTag                              |
      | Default     | Cluster    | Metadata Type | Teradata,SC18TeradataCatalogerWithoutDBFilter,Test_BA_Teradata | 10.33.6.190        | SC18TeradataCatalogerWithoutDBFilter |
      | Default     | Service    | Metadata Type | Teradata,SC18TeradataCatalogerWithoutDBFilter,Test_BA_Teradata | Teradata:6666      | SC18TeradataCatalogerWithoutDBFilter |
      | Default     | Trigger    | Metadata Type | Teradata,SC18TeradataCatalogerWithoutDBFilter,Test_BA_Teradata | UPDATE_EMP_TRIG    | SC18TeradataCatalogerWithoutDBFilter |
  ...
  Scenario: SC#43-Start the Plugin Configuration which has Arguments and Database filter
    Given Execute REST API with following parameters
      | Header           | Query | Param | type         | url                                                                                                           | body                                                                                                              | response code | response message                         | jsonPath                                                                      | endpointType | itemName |
      | application/json |       |       | Put          | settings/analyzers/TeradataDBCataloger/TeradataCatalogerWithArgumentAndDBfilter                               | ida/jdbcAnalyzerPayloads/Teradata_V15/PluginConfiguration/sc19TeradataCatalogerWithArgumentAndDBfilterConfig.json | 204           |                                          |                                                                               |              |          |
  ...
  Scenario: SC#45-Verify TeradataDBCataloger does not scans and collects and any data if username and password are incorrectly provided
    Given Execute REST API with following parameters
      | Header           | Query | Param | type         | url                                                                                                            | body                                                                                                               | response code | response message                          | jsonPath                                                                       | endpointType | itemName |
      | application/json |       |       | Put          | settings/analyzers/TeradataDBCataloger/TeradataCatalogerWithIncorrectCredentials                               | ida/jdbcAnalyzerPayloads/Teradata_V15/PluginConfiguration/sc21TeradataCatalogerWithIncorrectCredentialsConfig.json | 204           |                                           |                                                                                |              |          |
    ...
    Then Analysis log "cataloger/TeradataDBCataloger/TeradataCatalogerWithIncorrectCredentials%" should display below info/error/warning
      | type  | logValue                                | logCode | pluginName | removableText |
      | ERROR | No JDBC connection could be established |         |            |               |
  ...
  Scenario: SC#46-Drop Constraint from Table
    Given user connects to the database and performs the following operation
      | databaseConnection | Operation    | queryPath     | queryPage       | queryField     |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | dropConstraint |

  @jdbc
  Scenario: SC#46-Drop Table
    Given user connects to the database and performs the following operation
      | databaseConnection | Operation | Schema | Table                | Database           |
      | teradata           | DROP      |        | TABLE_PRIMARY        | automation_test_db |
      | teradata           | DROP      |        | TERADATA_TAG_DETAILS | automation_test_db |
      | teradata           | DROP      |        | TERADATA_EMPTY       | automation_test_db |
      | teradata           | DROP      |        | TERADATA_TABLE       | automation_test_db |
      | teradata           | DROP      |        | ForeignTest          | automation_test_db |
      | teradata           | DROP      |        | UniqueTest           | automation_test_db |
      | teradata           | DROP      |        | PrimaryTest          | automation_test_db |
  ...
  Scenario: SC#46-Delete and Drop Database and User
    Given user connects to the database and performs the following operation
      | databaseConnection | Operation    | queryPath     | queryPage       | queryField     |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | deleteDatabase |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | dropDatabase   |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | deleteUser     |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | dropUser       |
  ...
  Scenario:SC#47-Create User in TeradataDatabase for filter scenario
    Given user connects to the database and performs the following operation
      | databaseConnection | Operation    | queryPath     | queryPage       | queryField              |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | createUser2InTeradataDB |
    And user connects to the database and performs the following operation
      | databaseConnection | Operation    | queryPath     | queryPage       | queryField          |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | createDB2inTeradata |
    And user connects to the database and performs the following operation
      | databaseConnection | Operation    | queryPath     | queryPage       | queryField           |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | grantUser2Permission |
    And user connects to the database and performs the following operation
      | databaseConnection | Operation    | queryPath     | queryPage       | queryField                 |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | createConstraintTable2     |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | createEmptyTimeStampTable2 |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | createUniqueConstraint2    |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | createPrimaryConstraint2   |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | createForeignConstraint2   |
    And sync the test execution for "20" seconds
    And user connects to the database and performs the following operation
      | databaseConnection | Operation    | queryPath     | queryPage       | queryField      |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | createTable2    |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecorddb2 |
  ...
  Scenario Outline: SC#48-Run teradata cataloger with database in filter configuraton
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                                                | body                                                                                             | response code | response message              | jsonPath                                                           |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/TeradataDBCataloger/TeraDataWithDatabaseFilterSC1                               | ida/jdbcAnalyzerPayloads/Teradata_V15/PluginConfiguration/sc23TeraDataWithDatabaseFilterSC1.json | 204           |                               |                                                                    |
      ...
      | IDC         | TestSystemUser | application/json | raw   | false | RecursiveGet | /extensions/analyzers/status/LocalNode/cataloger/TeradataDBCataloger/TeraDataWithDatabaseFilterSC1 |                                                                                                  | 200           | IDLE                          | $.[?(@.configurationName=='TeraDataWithDatabaseFilterSC1')].status |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/TeradataDBCataloger/TeraDataWithDatabaseFilterSC2                               | ida/jdbcAnalyzerPayloads/Teradata_V15/PluginConfiguration/sc23TeraDataWithDatabaseFilterSC2.json | 204           |                               |                                                                    |
      ...
      | IDC         | TestSystemUser | application/json | raw   | false | RecursiveGet | /extensions/analyzers/status/LocalNode/cataloger/TeradataDBCataloger/TeraDataWithDatabaseFilterSC2 |                                                                                                  | 200           | IDLE                          | $.[?(@.configurationName=='TeraDataWithDatabaseFilterSC2')].status |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/TeradataDBCataloger/TeraDataWithDatabaseFilterSC3                               | ida/jdbcAnalyzerPayloads/Teradata_V15/PluginConfiguration/sc23TeraDataWithDatabaseFilterSC3.json | 204           |                               |                                                                    |
  ...
  Scenario Outline: SC#50-Run teradata cataloger with user in filter configuraton
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                                            | body                                                                                         | response code | response message          | jsonPath                                                       |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/TeradataDBCataloger/TeraDataWithUserFilterSC4                               | ida/jdbcAnalyzerPayloads/Teradata_V15/PluginConfiguration/sc24TeraDataWithUserFilterSC4.json | 204           |                           |                                                                |
      ...
      | IDC         | TestSystemUser | application/json | raw   | false | RecursiveGet | /extensions/analyzers/status/LocalNode/cataloger/TeradataDBCataloger/TeraDataWithUserFilterSC4 |                                                                                              | 200           | IDLE                      | $.[?(@.configurationName=='TeraDataWithUserFilterSC4')].status |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/TeradataDBCataloger/TeraDataWithUserFilterSC5                               | ida/jdbcAnalyzerPayloads/Teradata_V15/PluginConfiguration/sc24TeraDataWithUserFilterSC5.json | 204           |                           |                                                                |
      ...
      | IDC         | TestSystemUser | application/json | raw   | false | RecursiveGet | /extensions/analyzers/status/LocalNode/cataloger/TeradataDBCataloger/TeraDataWithUserFilterSC5 |                                                                                              | 200           | IDLE                      | $.[?(@.configurationName=='TeraDataWithUserFilterSC5')].status |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/TeradataDBCataloger/TeraDataWithUserFilterSC6                               | ida/jdbcAnalyzerPayloads/Teradata_V15/PluginConfiguration/sc24TeraDataWithUserFilterSC6.json | 204           |                           |                                                                |
  ...
  Scenario: SC#51: Verify Scan TeraData cataloger collects items when username provided with regular expression
    ...
    Then results panel "search item count" should be displayed as "Select all 15231 items" in Item Search results page
    Then user verify Facet type and counts with following values under "Metadata Type" section in item search results page
      | facetType | count |
      | Database  | 1     |
    And user performs "facet selection" in "Database" attribute under "Metadata Type" facets in Item Search results page
  ...
  Scenario:SC#51 Delete and Drop Database and User of filter scenarios
    Given user connects to the database and performs the following operation
      | databaseConnection | Operation    | queryPath     | queryPage       | queryField      |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | deleteDatabase2 |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | dropDatabase2   |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | deleteUser2     |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | dropUser2       |
  ...
  Scenario: SC#52-Create Table1 and insert value for PII Tags verification
    Given user connects to the database and performs the following operation
      | databaseConnection | Operation    | queryPath     | queryPage       | queryField             |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | createPIITable1        |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord1PIITable1 |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord2PIITable1 |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord3PIITable1 |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord4PIITable1 |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord5PIITable1 |

  @jdbc
  Scenario: SC#52-Create Table2 and insert value for PII Tags verification
    Given user connects to the database and performs the following operation
      | databaseConnection | Operation    | queryPath     | queryPage       | queryField             |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | createPIITable2        |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord1PIITable2 |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord2PIITable2 |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord3PIITable2 |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord4PIITable2 |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord5PIITable2 |

  @jdbc
  Scenario: SC#52-Create Table3 and insert value for PII Tags verification
    Given user connects to the database and performs the following operation
      | databaseConnection | Operation    | queryPath     | queryPage       | queryField              |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | createPIITable3         |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord1PIITable3  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord2PIITable3  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord3PIITable3  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord4PIITable3  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord5PIITable3  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord6PIITable3  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord7PIITable3  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord8PIITable3  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord9PIITable3  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord10PIITable3 |

  @jdbc
  Scenario: SC#52-Create Table4 and insert value for PII Tags verification
    Given user connects to the database and performs the following operation
      | databaseConnection | Operation    | queryPath     | queryPage       | queryField              |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | createPIITable4         |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord1PIITable4  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord2PIITable4  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord3PIITable4  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord4PIITable4  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord5PIITable4  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord6PIITable4  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord7PIITable4  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord8PIITable4  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord9PIITable4  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord10PIITable4 |

  @jdbc
  Scenario: SC#52-Create Table5 and insert value for PII Tags verification
    Given user connects to the database and performs the following operation
      | databaseConnection | Operation    | queryPath     | queryPage       | queryField              |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | createPIITable5         |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord1PIITable5  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord2PIITable5  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord3PIITable5  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord4PIITable5  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord5PIITable5  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord6PIITable5  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord7PIITable5  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord8PIITable5  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord9PIITable5  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord10PIITable5 |

  @jdbc
  Scenario: SC#52-Create Table6 and insert value for PII Tags verification
    Given user connects to the database and performs the following operation
      | databaseConnection | Operation    | queryPath     | queryPage       | queryField              |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | createPIITable6         |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord1PIITable6  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord2PIITable6  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord3PIITable6  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord4PIITable6  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord5PIITable6  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord6PIITable6  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord7PIITable6  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord8PIITable6  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord9PIITable6  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord10PIITable6 |

  @jdbc
  Scenario: SC#52-Create Table7 and insert value for PII Tags verification
    Given user connects to the database and performs the following operation
      | databaseConnection | Operation    | queryPath     | queryPage       | queryField              |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | createPIITable7         |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord1PIITable7  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord2PIITable7  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord3PIITable7  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord4PIITable7  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord5PIITable7  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord6PIITable7  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord7PIITable7  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord8PIITable7  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord9PIITable7  |
      | teradata           | EXECUTEQUERY | json/IDA.json | teradataQueries | insertRecord10PIITable7 |

  Scenario Outline:SC#52:Create root tag and sub tag for TeradataDB and Update policy tags for TeradataDBAnalyzer
    Given endpoint for "<ServiceName>" for "<ServiceUser>" having "<Header>" and query param with "<Query>" "<Param>" for request type "<type>" with url "<url>" and body "<body>" and verify "<response code>" and "<response message>" using "<jsonPath>"
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type | url                     | body                                                                           | response code | response message | jsonPath |
      | IDC         | TestSystemUser | application/json | raw   | false | Put  | tags/Default/structures | ida/jdbcAnalyzerPayloads/Teradata_V15/policyEngine/teradataDBTagStructure.json | 200           |                  |          |
      | IDC         | TestSystemUser | application/json | raw   | false | Put  | policy/tagging/actions  | ida/jdbcAnalyzerPayloads/Teradata_V15/policyEngine/teradataDB_policy1.1.0.json | 204           |                  |          |
  ...
  Scenario Outline: SC#53:Run TeradataDBCataloger & TeradataDBAnalyzer to verify PII Tags
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                                       | body                                                                                   | response code | response message     | jsonPath                                                  |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/TeradataDBCataloger/TeraDataCatalogerPII                               | ida/jdbcAnalyzerPayloads/Teradata_V15/PluginConfiguration/sc2TeradataCatalogerPII.json | 204           |                      |                                                           |
  ...
  Scenario: SC#54: Verify PII Tags gets assigned to the below columns in table: TAGDETAILS_ALLMATCH
    Given Tag verification of UI items in API for all the DataTypes
      ...
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_ALLMATCH | EMAIL     | TeradataDBEmailPII_SC1Tag,TeradataDBEmailPII_SC3Tag,TeradataDBEmailPII_SC8Tag             | ColumnQuerywithoutSchema | TagAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_ALLMATCH | GENDER    | TeradataDBGenderPII_SC1Tag,TeradataDBGenderPII_SC3Tag,TeradataDBGenderPII_SC8Tag          | ColumnQuerywithoutSchema | TagAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_ALLMATCH | IPADDRESS | TeradataDBIPAddressPII_SC1Tag,TeradataDBIPAddressPII_SC3Tag,TeradataDBIPAddressPII_SC8Tag | ColumnQuerywithoutSchema | TagAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_ALLMATCH | SSN       | TeradataDBSSNPII_SC1Tag,TeradataDBSSNPII_SC3Tag,TeradataDBSSNPII_SC8Tag                   | ColumnQuerywithoutSchema | TagAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_ALLMATCH | FULL_NAME | TeradataDBFullNamePII_SC1Tag,TeradataDBFullNamePII_SC3Tag,TeradataDBFullNamePII_SC8Tag    | ColumnQuerywithoutSchema | TagAssigned |

  @jdbc @PIITag
  Scenario: SC#54: Verify PII Tags doesn't gets assigned to the below columns in table: TAGDETAILS_ALLMATCH
    Given Tag verification of UI items in API for all the DataTypes
      | ClusterName | ServiceName   | DatabaseName       | TableName/Filename  | Column    | Tags                                                                                                                                                     | Query                    | Action         |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_ALLMATCH | EMAIL     | TeradataDBEmailPII_SC2Tag,TeradataDBEmailPII_SC4Tag,TeradataDBEmailPII_SC11Tag,TeradataDBEmailPII_SC12Tag,TeradataDBEmailPII_SC13Tag                     | ColumnQuerywithoutSchema | TagNotAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_ALLMATCH | GENDER    | TeradataDBGenderPII_SC2Tag,TeradataDBGenderPII_SC4Tag,TeradataDBGenderPII_SC11Tag,TeradataDBGenderPII_SC12Tag,TeradataDBGenderPII_SC13Tag                | ColumnQuerywithoutSchema | TagNotAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_ALLMATCH | IPADDRESS | TeradataDBIPAddressPII_SC2Tag,TeradataDBIPAddressPII_SC4Tag,TeradataDBIPAddressPII_SC11Tag,TeradataDBIPAddressPII_SC12Tag,TeradataDBIPAddressPII_SC13Tag | ColumnQuerywithoutSchema | TagNotAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_ALLMATCH | SSN       | TeradataDBSSNPII_SC2Tag,TeradataDBSSNPII_SC4Tag,TeradataDBSSNPII_SC11Tag,TeradataDBSSNPII_SC12Tag,TeradataDBSSNPII_SC13Tag                               | ColumnQuerywithoutSchema | TagNotAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_ALLMATCH | FULL_NAME | TeradataDBFullNamePII_SC2Tag,TeradataDBFullNamePII_SC4Tag,TeradataDBFullNamePII_SC11Tag,TeradataDBFullNamePII_SC12Tag,TeradataDBFullNamePII_SC13Tag      | ColumnQuerywithoutSchema | TagNotAssigned |

  @jdbc @PIITag
  Scenario: SC#55: Verify PII Tags gets assigned to the below columns in table: TAGDETAILS_ALLEMPTY
    Given Tag verification of UI items in API for all the DataTypes
      | ClusterName | ServiceName   | DatabaseName       | TableName/Filename  | Column    | Tags                                                                                                                     | Query                    | Action      |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_ALLEMPTY | EMAIL     | TeradataDBEmailPII_SC1Tag,TeradataDBEmailPII_SC3Tag,TeradataDBEmailPII_SC8Tag,TeradataDBEmailPII_SC14Tag                 | ColumnQuerywithoutSchema | TagAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_ALLEMPTY | IPADDRESS | TeradataDBIPAddressPII_SC1Tag,TeradataDBIPAddressPII_SC3Tag,TeradataDBIPAddressPII_SC8Tag,TeradataDBIPAddressPII_SC14Tag | ColumnQuerywithoutSchema | TagAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_ALLEMPTY | SSN       | TeradataDBSSNPII_SC1Tag,TeradataDBSSNPII_SC3Tag,TeradataDBSSNPII_SC8Tag,TeradataDBSSNPII_SC14Tag                         | ColumnQuerywithoutSchema | TagAssigned |

  @jdbc @PIITag
  Scenario: SC#55: Verify PII Tags doesn't gets assigned to the below columns in table: TAGDETAILS_ALLEMPTY
    Given Tag verification of UI items in API for all the DataTypes
      | ClusterName | ServiceName   | DatabaseName       | TableName/Filename  | Column    | Tags                                                                                                                                                     | Query                    | Action         |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_ALLEMPTY | EMAIL     | TeradataDBEmailPII_SC2Tag,TeradataDBEmailPII_SC4Tag,TeradataDBEmailPII_SC11Tag,TeradataDBEmailPII_SC12Tag,TeradataDBEmailPII_SC13Tag                     | ColumnQuerywithoutSchema | TagNotAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_ALLEMPTY | GENDER    | TeradataDBGenderPII_SC2Tag,TeradataDBGenderPII_SC4Tag,TeradataDBGenderPII_SC11Tag,TeradataDBGenderPII_SC12Tag,TeradataDBGenderPII_SC13Tag                | ColumnQuerywithoutSchema | TagNotAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_ALLEMPTY | IPADDRESS | TeradataDBIPAddressPII_SC2Tag,TeradataDBIPAddressPII_SC4Tag,TeradataDBIPAddressPII_SC11Tag,TeradataDBIPAddressPII_SC12Tag,TeradataDBIPAddressPII_SC13Tag | ColumnQuerywithoutSchema | TagNotAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_ALLEMPTY | SSN       | TeradataDBSSNPII_SC2Tag,TeradataDBSSNPII_SC4Tag,TeradataDBSSNPII_SC11Tag,TeradataDBSSNPII_SC12Tag,TeradataDBSSNPII_SC13Tag                               | ColumnQuerywithoutSchema | TagNotAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_ALLEMPTY | FULL_NAME | TeradataDBFullNamePII_SC2Tag,TeradataDBFullNamePII_SC4Tag,TeradataDBFullNamePII_SC11Tag,TeradataDBFullNamePII_SC12Tag,TeradataDBFullNamePII_SC13Tag      | ColumnQuerywithoutSchema | TagNotAssigned |

  @jdbc @PIITag
  Scenario: SC#56: Verify PII Tags gets assigned to the below columns in table: TAGDETAILS_Ratiolessthan05EmptyFalse
    Given Tag verification of UI items in API for all the DataTypes
      | ClusterName | ServiceName   | DatabaseName       | TableName/Filename                   | Column    | Tags                                                                                                                     | Query                    | Action      |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_Ratiolessthan05EmptyFalse | EMAIL     | TeradataDBEmailPII_SC1Tag,TeradataDBEmailPII_SC3Tag,TeradataDBEmailPII_SC5Tag,TeradataDBEmailPII_SC10Tag                 | ColumnQuerywithoutSchema | TagAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_Ratiolessthan05EmptyFalse | GENDER    | TeradataDBGenderPII_SC1Tag,TeradataDBGenderPII_SC3Tag,TeradataDBGenderPII_SC5Tag,TeradataDBGenderPII_SC10Tag             | ColumnQuerywithoutSchema | TagAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_Ratiolessthan05EmptyFalse | IPADDRESS | TeradataDBIPAddressPII_SC1Tag,TeradataDBIPAddressPII_SC3Tag,TeradataDBIPAddressPII_SC5Tag,TeradataDBIPAddressPII_SC10Tag | ColumnQuerywithoutSchema | TagAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_Ratiolessthan05EmptyFalse | SSN       | TeradataDBSSNPII_SC5Tag,TeradataDBSSNPII_SC10Tag                                                                         | ColumnQuerywithoutSchema | TagAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_Ratiolessthan05EmptyFalse | FULL_NAME | TeradataDBFullNamePII_SC5Tag,TeradataDBFullNamePII_SC10Tag                                                               | ColumnQuerywithoutSchema | TagAssigned |

  @jdbc @PIITag
  Scenario: SC#56: Verify PII Tags doesn't gets assigned to the below columns in table: TAGDETAILS_Ratiolessthan05EmptyFalse
    Given Tag verification of UI items in API for all the DataTypes
      | ClusterName | ServiceName   | DatabaseName       | TableName/Filename                   | Column    | Tags                                                                                                                                                                                                          | Query                    | Action         |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_Ratiolessthan05EmptyFalse | EMAIL     | TeradataDBEmailPII_SC2Tag,TeradataDBEmailPII_SC4Tag,TeradataDBEmailPII_SC11Tag,TeradataDBEmailPII_SC12Tag,TeradataDBEmailPII_SC13Tag                                                                          | ColumnQuerywithoutSchema | TagNotAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_Ratiolessthan05EmptyFalse | GENDER    | TeradataDBGenderPII_SC2Tag,TeradataDBGenderPII_SC4Tag,TeradataDBGenderPII_SC11Tag,TeradataDBGenderPII_SC12Tag,TeradataDBGenderPII_SC13Tag                                                                     | ColumnQuerywithoutSchema | TagNotAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_Ratiolessthan05EmptyFalse | IPADDRESS | TeradataDBIPAddressPII_SC2Tag,TeradataDBIPAddressPII_SC4Tag,TeradataDBIPAddressPII_SC11Tag,TeradataDBIPAddressPII_SC12Tag,TeradataDBIPAddressPII_SC13Tag                                                      | ColumnQuerywithoutSchema | TagNotAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_Ratiolessthan05EmptyFalse | SSN       | TeradataDBSSNPII_SC1Tag,TeradataDBSSNPII_SC3Tag,TeradataDBSSNPII_SC2Tag,TeradataDBSSNPII_SC4Tag,TeradataDBSSNPII_SC11Tag,TeradataDBSSNPII_SC12Tag,TeradataDBSSNPII_SC13Tag                                    | ColumnQuerywithoutSchema | TagNotAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_Ratiolessthan05EmptyFalse | FULL_NAME | TeradataDBFullNamePII_SC1Tag,TeradataDBFullNamePII_SC3Tag,TeradataDBFullNamePII_SC2Tag,TeradataDBFullNamePII_SC4Tag,TeradataDBFullNamePII_SC11Tag,TeradataDBFullNamePII_SC12Tag,TeradataDBFullNamePII_SC13Tag | ColumnQuerywithoutSchema | TagNotAssigned |

  @jdbc @PIITag
  Scenario: SC#57: Verify PII Tags gets assigned to the below columns in table: TAGDETAILS_Ratiogreaterthan05EmptyFalseTrue
    Given Tag verification of UI items in API for all the DataTypes
      | ClusterName | ServiceName   | DatabaseName       | TableName/Filename                          | Column    | Tags                                                                                                                                                                                 | Query                    | Action      |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_Ratiogreaterthan05EmptyFalseTrue | EMAIL     | TeradataDBEmailPII_SC1Tag,TeradataDBEmailPII_SC3Tag,TeradataDBEmailPII_SC5Tag,TeradataDBEmailPII_SC6Tag,TeradataDBEmailPII_SC7Tag,TeradataDBEmailPII_SC10Tag                         | ColumnQuerywithoutSchema | TagAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_Ratiogreaterthan05EmptyFalseTrue | GENDER    | TeradataDBGenderPII_SC1Tag,TeradataDBGenderPII_SC3Tag,TeradataDBGenderPII_SC5Tag,TeradataDBGenderPII_SC10Tag                                                                         | ColumnQuerywithoutSchema | TagAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_Ratiogreaterthan05EmptyFalseTrue | IPADDRESS | TeradataDBIPAddressPII_SC1Tag,TeradataDBIPAddressPII_SC3Tag,TeradataDBIPAddressPII_SC5Tag,TeradataDBIPAddressPII_SC6Tag,TeradataDBIPAddressPII_SC7Tag,TeradataDBIPAddressPII_SC10Tag | ColumnQuerywithoutSchema | TagAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_Ratiogreaterthan05EmptyFalseTrue | SSN       | TeradataDBSSNPII_SC5Tag,TeradataDBSSNPII_SC10Tag                                                                                                                                     | ColumnQuerywithoutSchema | TagAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_Ratiogreaterthan05EmptyFalseTrue | FULL_NAME | TeradataDBFullNamePII_SC5Tag,TeradataDBFullNamePII_SC10Tag                                                                                                                           | ColumnQuerywithoutSchema | TagAssigned |
  ...
  Scenario: SC#57: Verify PII Tags doesn't gets assigned to the below columns in table: TAGDETAILS_Ratiogreaterthan05EmptyFalseTrue
    Given Tag verification of UI items in API for all the DataTypes
      | ClusterName | ServiceName   | DatabaseName       | TableName/Filename                          | Column    | Tags                                                                                                                                                                                                          | Query                    | Action         |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_Ratiogreaterthan05EmptyFalseTrue | EMAIL     | TeradataDBEmailPII_SC2Tag,TeradataDBEmailPII_SC4Tag,TeradataDBEmailPII_SC11Tag,TeradataDBEmailPII_SC12Tag,TeradataDBEmailPII_SC13Tag                                                                          | ColumnQuerywithoutSchema | TagNotAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_Ratiogreaterthan05EmptyFalseTrue | GENDER    | TeradataDBGenderPII_SC2Tag,TeradataDBGenderPII_SC4Tag,TeradataDBGenderPII_SC11Tag,TeradataDBGenderPII_SC12Tag,TeradataDBGenderPII_SC13Tag                                                                     | ColumnQuerywithoutSchema | TagNotAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_Ratiogreaterthan05EmptyFalseTrue | IPADDRESS | TeradataDBIPAddressPII_SC2Tag,TeradataDBIPAddressPII_SC4Tag,TeradataDBIPAddressPII_SC11Tag,TeradataDBIPAddressPII_SC12Tag,TeradataDBIPAddressPII_SC13Tag                                                      | ColumnQuerywithoutSchema | TagNotAssigned |
  ...
  Scenario: SC#58: Verify PII Tags gets assigned to the below columns in table: TAGDETAILS_RatioEqualTo05EmptyFalse
    Given Tag verification of UI items in API for all the DataTypes
      | ClusterName | ServiceName   | DatabaseName       | TableName/Filename                  | Column    | Tags                                                                                      | Query                    | Action      |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_RatioEqualTo05EmptyFalse | EMAIL     | TeradataDBEmailPII_SC1Tag,TeradataDBEmailPII_SC3Tag,TeradataDBEmailPII_SC9Tag             | ColumnQuerywithoutSchema | TagAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_RatioEqualTo05EmptyFalse | GENDER    | TeradataDBGenderPII_SC1Tag,TeradataDBGenderPII_SC3Tag,TeradataDBGenderPII_SC9Tag          | ColumnQuerywithoutSchema | TagAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_RatioEqualTo05EmptyFalse | IPADDRESS | TeradataDBIPAddressPII_SC1Tag,TeradataDBIPAddressPII_SC3Tag,TeradataDBIPAddressPII_SC9Tag | ColumnQuerywithoutSchema | TagAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_RatioEqualTo05EmptyFalse | SSN       | TeradataDBSSNPII_SC1Tag,TeradataDBSSNPII_SC3Tag,TeradataDBSSNPII_SC9Tag                   | ColumnQuerywithoutSchema | TagAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_RatioEqualTo05EmptyFalse | FULL_NAME | TeradataDBFullNamePII_SC1Tag,TeradataDBFullNamePII_SC3Tag,TeradataDBFullNamePII_SC9Tag    | ColumnQuerywithoutSchema | TagAssigned |

  @jdbc @PIITag
  Scenario: SC#58: Verify PII Tags doesn't gets assigned to the below columns in table: TAGDETAILS_RatioEqualTo05EmptyFalse
    Given Tag verification of UI items in API for all the DataTypes
      | ClusterName | ServiceName   | DatabaseName       | TableName/Filename                  | Column    | Tags                                                                                                                                                     | Query                    | Action         |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_RatioEqualTo05EmptyFalse | EMAIL     | TeradataDBEmailPII_SC2Tag,TeradataDBEmailPII_SC4Tag,TeradataDBEmailPII_SC11Tag,TeradataDBEmailPII_SC12Tag,TeradataDBEmailPII_SC13Tag                     | ColumnQuerywithoutSchema | TagNotAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_RatioEqualTo05EmptyFalse | GENDER    | TeradataDBGenderPII_SC2Tag,TeradataDBGenderPII_SC4Tag,TeradataDBGenderPII_SC11Tag,TeradataDBGenderPII_SC12Tag,TeradataDBGenderPII_SC13Tag                | ColumnQuerywithoutSchema | TagNotAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_RatioEqualTo05EmptyFalse | IPADDRESS | TeradataDBIPAddressPII_SC2Tag,TeradataDBIPAddressPII_SC4Tag,TeradataDBIPAddressPII_SC11Tag,TeradataDBIPAddressPII_SC12Tag,TeradataDBIPAddressPII_SC13Tag | ColumnQuerywithoutSchema | TagNotAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_RatioEqualTo05EmptyFalse | SSN       | TeradataDBSSNPII_SC2Tag,TeradataDBSSNPII_SC4Tag,TeradataDBSSNPII_SC11Tag,TeradataDBSSNPII_SC12Tag,TeradataDBSSNPII_SC13Tag                               | ColumnQuerywithoutSchema | TagNotAssigned |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_RatioEqualTo05EmptyFalse | FULL_NAME | TeradataDBFullNamePII_SC2Tag,TeradataDBFullNamePII_SC4Tag,TeradataDBFullNamePII_SC11Tag,TeradataDBFullNamePII_SC12Tag,TeradataDBFullNamePII_SC13Tag      | ColumnQuerywithoutSchema | TagNotAssigned |

  @jdbc @PIITag
  Scenario: SC#59: Verify PII Tags gets assigned to the below columns in table: TAGDETAILS_Ratiogreaterthan05MatchFullTrue
    Given Tag verification of UI items in API for all the DataTypes
      | ClusterName | ServiceName   | DatabaseName       | TableName/Filename                         | Column   | Tags                          | Query                    | Action      |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_Ratiogreaterthan05MatchFullTrue | Comments | TeradataDBFullMatchPII_SC2Tag | ColumnQuerywithoutSchema | TagAssigned |
  ...
  Scenario: SC#59: Verify PII Tags doesn't gets assigned to the below columns in table: TAGDETAILS_Ratiogreaterthan05MatchFullTrue
    Given Tag verification of UI items in API for all the DataTypes
      | ClusterName | ServiceName   | DatabaseName       | TableName/Filename                         | Column   | Tags                          | Query                    | Action         |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_Ratiogreaterthan05MatchFullTrue | Comments | TeradataDBFullMatchPII_SC1Tag | ColumnQuerywithoutSchema | TagNotAssigned |

  @jdbc @PIITag
  Scenario: SC#60: Verify PII Tags gets assigned to the below columns in table: TAGDETAILS_Ratiolesserthan05MatchFullTrue
    Given Tag verification of UI items in API for all the DataTypes
      | ClusterName | ServiceName   | DatabaseName       | TableName/Filename                        | Column   | Tags                          | Query                    | Action      |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_Ratiolesserthan05MatchFullTrue | Comments | TeradataDBFullMatchPII_SC4Tag | ColumnQuerywithoutSchema | TagAssigned |
  ...
  Scenario: SC#60: Verify PII Tags doesn't gets assigned to the below columns in table: TAGDETAILS_Ratiolesserthan05MatchFullTrue
    Given Tag verification of UI items in API for all the DataTypes
      | ClusterName | ServiceName   | DatabaseName       | TableName/Filename                        | Column   | Tags                          | Query                    | Action         |
      | 10.33.6.190 | Teradata:6666 | automation_test_db | TAGDETAILS_Ratiolesserthan05MatchFullTrue | Comments | TeradataDBFullMatchPII_SC3Tag | ColumnQuerywithoutSchema | TagNotAssigned |
