@MLP-24181
Feature:Verification of JDBC Analyzer using Oracle 18c PDB database and plugin validation(Oracle 18C Testing On Prem(PDB))
  ...
  Scenario:SC#1_1_Update credential payload json for Oracle18cPDB
    Given User update the below "Oracle18cPDB Readonly credentials" in following files using json path
      ...
      | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleCredentials.json | $..userName | $..password |
...
#      | IDC         | TestSystemUser | application/json |       |       | Get  | settings/credentials/EDIBusOracleCredentials        |                                                                             | 200           |                  |          |
      | IDC         | TestSystemUser | application/json | raw   | false | Put  | settings/credentials/Oracle18cPDBCredentials        | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleCredentials.json            | 200           |                  |          |
      | IDC         | TestSystemUser | application/json |       |       | Get  | settings/credentials/Oracle18cPDBCredentials        |                                                                         | 200           |                  |          |
      | IDC         | TestSystemUser | application/json | raw   | false | Put  | settings/credentials/Oracle18cPDBInvalidCredentials | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleInvalidCredentials.json     | 200           |                  |          |
      | IDC         | TestSystemUser | application/json |       |       | Get  | settings/credentials/Oracle18cPDBInvalidCredentials |                                                                         | 200           |                  |          |
      | IDC         | TestSystemUser | application/json | raw   | false | Put  | settings/credentials/Oracle18cPDBEmptyCredentials   | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleCredentialsEmpty.json       | 200           |                  |          |
      | IDC         | TestSystemUser | application/json |       |       | Get  | settings/credentials/Oracle18cPDBEmptyCredentials   |                                                                         | 200           |                  |          |
      | IDC         | TestSystemUser | application/json | raw   | false | Post | items/Default/root                                  | ida/jdbcAnalyzerPayloads/Oracle18cPDB/businessApplicationCataloger.json | 200           |                  |          |
      | IDC         | TestSystemUser | application/json | raw   | false | Post | items/Default/root                                  | ida/jdbcAnalyzerPayloads/Oracle18cPDB/businessApplicationAnalyzer.json  | 200           |                  |          |
  ...
  Scenario:SC#1_3_Verify whether the background of the panel is displayed in red when connection is unsuccessful due to invalid / Empty credentials in Local Node
    ...
    And user "select dropdown" in Add Data Source Page
      ...
      | Credential       | Oracle18cPDBInvalidCredentials |
      | Node             | LocalNode                      |
    And user "enter text" in Add Data Source Page
      | fieldName | attribute                                                                         |
      | Name      | Oracle18cPDBDS_Test                                                               |
      | Label     | Oracle18cPDBDS_Test                                                               |
      | URL       | jdbc:oracle:thin:@diqscanora01v.diq.qa.asgint.loc:1521/PDBDB18C.DIQ.QA.ASGINT.LOC |
...
#    And user verifies "Save Button" is "disabled" in "Add Configuration pop up"
    And user "select dropdown" in Add Data Source Page
      | fieldName  | attribute                    |
      | Credential | Oracle18cPDBEmptyCredentials |
    And user "click" on "Test Connection" button in "Add Data Sources Page"
    And user verifies "Failed datasource connection" is "displayed" in "Add Data Sources Page"
#    And user verifies "Save Button" is "disabled" in "Add Configuration pop up"
  ...
  Scenario:SC#1_4_Verify whether the background of the panel is displayed in green when connection is successful in Step1 pop up when user logs in for the first time in Local Node
    ...
    And user "select dropdown" in Add Data Source Page
      | fieldName        | attribute               |
      | Data Source Type | OracleDBDataSource      |
      | Credential       | Oracle18cPDBCredentials |
      | Node             | LocalNode               |
    And user "enter text" in Add Data Source Page
      | fieldName | attribute                                                                         |
      | Name      | Oracle18cPDBDS_Test                                                               |
  ...
  Scenario:SC#1_5_Verify whether the background in the Cataloger panel is red when connection is unsuccessful due to Invalid / Empty Credentials
    ...
    And user "select dropdown" in Add Configuration Page in Manage Configurations
      ...
      | Plugin      | OracleDBCataloger              |
      | Data Source | Oracle18cPDBDS_Test            |
      | Data Source | Oracle18cPDBDS_Test            |
      | Credential  | Oracle18cPDBInvalidCredentials |
      | Credential  | Oracle18cPDBInvalidCredentials |
    And user "enter text" in Add Data Source Page
      | fieldName | attribute                  |
      | Name      | Oracle18cPDBCataloger_Test |
    And user "click" on "Test Connection" button in "Add Data Sources Page"
...
#    And user verifies "Save Button" is "disabled" in "Add Configuration pop up"
  ...
  Scenario Outline:SC#2_1_Run the Plugin configurations for DataSource and run the Oracle18cPDB Cataloger
    Given endpoint for "<ServiceName>" for "<ServiceUser>" having "<Header>" and query param with "<Query>" "<Param>" for request type "<type>" with url "<url>" and body "<body>" and verify "<response code>" and "<response message>" using "<jsonPath>"
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                 | body                                                                                           | response code | response message                | jsonPath                                                             |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBDataSource                               | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleDataSource.json                                    | 204           |                                 |                                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | Get          | settings/analyzers/OracleDBDataSource                               |                                                                                                | 200           | Oracle18cPDBDS                  |                                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBCataloger                                | ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/OracleCatalogerWithSchemaFilter.json | 204           |                                 |                                                                      |
      ...
      | IDC         | TestSystemUser | application/json | raw   | false | Post         | extensions/analyzers/start/LocalNode/cataloger/OracleDBCataloger/*  | ida/jdbcAnalyzerPayloads/Oracle18cPDB/empty.json                                               | 200           |                                 |                                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/* |                                                                                                | 200           | IDLE                            | $.[?(@.configurationName=='OracleCatalogerWithSchemaFilter')].status |
...
#    Given User launch browser and traverse to login page
#    And user enter credentials for "System Administrator1" role
#    And user enters the search text "Orc18cPDBCataloger" and clicks on search
#    And user performs "facet selection" in "Orc18cPDBCataloger" attribute under "Tags" facets in Item Search results page
#    And user performs "facet selection" in "Orc18cPDBCataloger" attribute under "Tags" facets in Item Search results page
...
#    And Execute REST API with following parameters
#      | Header | Query | Param | type | url                                                                                                               | body                              | response code | response message | jsonPath |
#      |        |       |       | Post | searches/fulltext/Default?query=Orc18cPDBCataloger&advanced=false&natural=false&limit=1000&offset=0&limitFacets=1 | idc/EdiBusPayloads/TagFilter.json | 200           |                  |          |
...
#
  ...
  Scenario:SC#2_2_Verify the Database(OracleDB) Metadata,Schema(OracleDB) Metadata,Breadcumb hierarchy and Oracle Table should not have constraints in IDC UI and Database
    ...
    And user performs "facet selection" in "Orc18cPDBCataloger" attribute under "Tags" facets in Item Search results page
    And user enters the search text "Orc18cPDBCataloger" and clicks on search
    And user performs "definite facet selection" in "Orc18cPDBCataloger" attribute under "Tags" facets in Item Search results page
    And user performs "definite facet selection" in "Database" attribute under "Metadata Type" facets in Item Search results page
    And user performs "item click" on "PDBDB18C.DIQ.QA.ASGINT.LOC" item from search results
 ...
 ##6767911##
  ...
  Scenario Outline:SC#3_2_user retrieves ids for specific item name
    ...
    Examples:
      ...
      | APPDBPOSTGRES | Default | PERSON_INFO_PK             | Constraint | Constant.REST_DIR/response/Oracle18cPDB/actualJsonFiles/constraintIDs.json |
      | APPDBPOSTGRES | Default | FK_PERSON_INFO             | Constraint | Constant.REST_DIR/response/Oracle18cPDB/actualJsonFiles/constraintIDs.json |
      | APPDBPOSTGRES | Default | ORACLE_SUPPLIER_UNIQUETEST | Constraint | Constant.REST_DIR/response/Oracle18cPDB/actualJsonFiles/constraintIDs.json |
      | APPDBPOSTGRES | Default | ORACLE_SUPPLIER_UNIQUETEST | Index      | Constant.REST_DIR/response/Oracle18cPDB/actualJsonFiles/indexIDs.json      |
  ...
  Scenario Outline:SC#3_3_user copy the id to payload
    ...
    Examples:
      ...
      | Constant.REST_DIR/response/Oracle18cPDB/actualJsonFiles/constraintIDs.json | Constant.REST_DIR/response/Oracle18cPDB/payloads/person_info_pk.json                   | Constraint | $..PERSON_INFO_PK             |
      | Constant.REST_DIR/response/Oracle18cPDB/actualJsonFiles/constraintIDs.json | Constant.REST_DIR/response/Oracle18cPDB/payloads/fk_person_info.json                   | Constraint | $..FK_PERSON_INFO             |
      | Constant.REST_DIR/response/Oracle18cPDB/actualJsonFiles/constraintIDs.json | Constant.REST_DIR/response/Oracle18cPDB/payloads/oracle_supplier_uniquetest.json       | Constraint | $..ORACLE_SUPPLIER_UNIQUETEST |
      | Constant.REST_DIR/response/Oracle18cPDB/actualJsonFiles/indexIDs.json      | Constant.REST_DIR/response/Oracle18cPDB/payloads/oracle_supplier_uniquetest_index.json | Index      | $..ORACLE_SUPPLIER_UNIQUETEST |
  ...
  Scenario Outline:SC#3_4_user get the response of lineage edges and store the lineage values in file
    ...
    Examples:
      ...
      | Get     | searches/Default/query/queryDiagramOut/Default.Constraint:::DYN?what=id,type,name,catalog |      | Constant.REST_DIR/response/Oracle18cPDB/actualJsonFiles/constraintIDs.json | List | $..PERSON_INFO_PK             | 200        | $..edges.* | Constant.REST_DIR/response/Oracle18cPDB/actualJsonFiles/person_info_pk.json                   | PERSON_INFO_PK             |
      | Get     | searches/Default/query/queryDiagramOut/Default.Constraint:::DYN?what=id,type,name,catalog |      | Constant.REST_DIR/response/Oracle18cPDB/actualJsonFiles/constraintIDs.json | List | $..FK_PERSON_INFO             | 200        | $..edges.* | Constant.REST_DIR/response/Oracle18cPDB/actualJsonFiles/fk_person_info.json                   | FK_PERSON_INFO             |
      | Get     | searches/Default/query/queryDiagramOut/Default.Constraint:::DYN?what=id,type,name,catalog |      | Constant.REST_DIR/response/Oracle18cPDB/actualJsonFiles/constraintIDs.json | List | $..ORACLE_SUPPLIER_UNIQUETEST | 200        | $..edges.* | Constant.REST_DIR/response/Oracle18cPDB/actualJsonFiles/oracle_supplier_uniquetest.json       | ORACLE_SUPPLIER_UNIQUETEST |
      | Get     | searches/Default/query/queryDiagramOut/Default.Index:::DYN?what=id,type,name,catalog      |      | Constant.REST_DIR/response/Oracle18cPDB/actualJsonFiles/indexIDs.json      | List | $..ORACLE_SUPPLIER_UNIQUETEST | 200        | $..edges.* | Constant.REST_DIR/response/Oracle18cPDB/actualJsonFiles/oracle_supplier_uniquetest_index.json | ORACLE_SUPPLIER_UNIQUETEST |
  ...
  Scenario Outline:SC#3_5_user retrieve the name of id for each value stored in lineage data file
    ...
    Examples:
      | LineageFile                                                                                   | Name                       |
      | Constant.REST_DIR/response/Oracle18cPDB/actualJsonFiles/person_info_pk.json                   | PERSON_INFO_PK             |
      | Constant.REST_DIR/response/Oracle18cPDB/actualJsonFiles/fk_person_info.json                   | FK_PERSON_INFO             |
      | Constant.REST_DIR/response/Oracle18cPDB/actualJsonFiles/oracle_supplier_uniquetest.json       | ORACLE_SUPPLIER_UNIQUETEST |
      | Constant.REST_DIR/response/Oracle18cPDB/actualJsonFiles/oracle_supplier_uniquetest_index.json | ORACLE_SUPPLIER_UNIQUETEST |


  Scenario:SC#3_6_Copy the file and remove the id value
    Given user copy the data from "rest/response/Oracle18cPDB/actualJsonFiles/person_info_pk.json" file to "rest/payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/person_info_pk.json" file
    And user copy the data from "rest/response/Oracle18cPDB/actualJsonFiles/fk_person_info.json" file to "rest/payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/fk_person_info.json" file
    And user copy the data from "rest/response/Oracle18cPDB/actualJsonFiles/oracle_supplier_uniquetest.json" file to "rest/payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/oracle_supplier_uniquetest.json" file
    And user copy the data from "rest/response/Oracle18cPDB/actualJsonFiles/oracle_supplier_uniquetest_index.json" file to "rest/payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/oracle_supplier_uniquetest_index.json" file
    And user "update" the json file "ida/jdbcAnalyzerPayloads/Oracle18cPDB/person_info_pk.json" file for following values
      | jsonPath | jsonValues | type   |
      | $..id    |            | String |
    And user "update" the json file "ida/jdbcAnalyzerPayloads/Oracle18cPDB/fk_person_info.json" file for following values
      | jsonPath | jsonValues | type   |
      | $..id    |            | String |
    And user "update" the json file "ida/jdbcAnalyzerPayloads/Oracle18cPDB/oracle_supplier_uniquetest.json" file for following values
      | jsonPath | jsonValues | type   |
      | $..id    |            | String |
    And user "update" the json file "ida/jdbcAnalyzerPayloads/Oracle18cPDB/oracle_supplier_uniquetest_index.json" file for following values
      | jsonPath | jsonValues | type   |
      | $..id    |            | String |
    And user copy the data from "rest/payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/person_info_pk.json" file to "rest/response/Oracle18cPDB/actualJsonFiles/person_info_pk.json" file
    And user copy the data from "rest/payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/fk_person_info.json" file to "rest/response/Oracle18cPDB/actualJsonFiles/fk_person_info.json" file
    And user copy the data from "rest/payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/oracle_supplier_uniquetest.json" file to "rest/response/Oracle18cPDB/actualJsonFiles/oracle_supplier_uniquetest.json" file
    And user copy the data from "rest/payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/oracle_supplier_uniquetest_index.json" file to "rest/response/Oracle18cPDB/actualJsonFiles/oracle_supplier_uniquetest_index.json" file
  ...
  Scenario Outline:SC#3_7_user compares the expected lineage data and actual lineage data
    ...
    Examples:
      ...
      | Constant.REST_DIR/response/Oracle18cPDB/expectedJsonFiles/person_info_pk.json                   | Constant.REST_DIR/response/Oracle18cPDB/actualJsonFiles/person_info_pk.json                   |
      | Constant.REST_DIR/response/Oracle18cPDB/expectedJsonFiles/fk_person_info.json                   | Constant.REST_DIR/response/Oracle18cPDB/actualJsonFiles/fk_person_info.json                   |
      | Constant.REST_DIR/response/Oracle18cPDB/expectedJsonFiles/oracle_supplier_uniquetest.json       | Constant.REST_DIR/response/Oracle18cPDB/actualJsonFiles/oracle_supplier_uniquetest.json       |
      | Constant.REST_DIR/response/Oracle18cPDB/expectedJsonFiles/oracle_supplier_uniquetest_index.json | Constant.REST_DIR/response/Oracle18cPDB/actualJsonFiles/oracle_supplier_uniquetest_index.json |
...
######################################################################################################################
  ...
  Scenario:SC#4_4_Verify OracleDBCataloger collects all the different columns of a table when table is created with all possible datatypes
    ...
    Then user performs click and verify in new window
      ...
      | Columns | TIMESTAMP6TZCOLUMN  | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.TIMESTAMP6TZCOLUMN  | Description     |
      | Columns | FLOATCOLUMN         | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.FLOATCOLUMN         | Description     |
      | Columns | BINARYDOUBLECOLUMN  | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.BINARYDOUBLECOLUMN  | Description     |
      | Columns | RAWCOLUMN           | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.RAWCOLUMN           | Description     |
      | Columns | UROWIDCOLUMN        | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.UROWIDCOLUMN        | Description     |
      | Columns | DATECOLUMN          | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.DATECOLUMN          | Description     |
      | Columns | TIMESTAMPCOLUMN     | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.TIMESTAMPCOLUMN     | Description     |
      | Columns | CLOBCOLUMN          | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.CLOBCOLUMN          | Description     |
      | Columns | NVARCHAR2COLUMN     | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.NVARCHAR2COLUMN     | Description     |
      | Columns | NCHARCOLUMN         | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.NCHARCOLUMN         | Description     |
      | Columns | CHARCOLUMN          | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.CHARCOLUMN          | Description     |
      | Columns | VARCHARCOLUMN       | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.VARCHARCOLUMN       | Description     |
      | Columns | VARCHAR2COLUMN      | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.VARCHAR2COLUMN      | Description     |
      | Columns | BLOBCOLUMN          | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.BLOBCOLUMN          | Description     |
      | Columns | BFILECOLUMN         | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.BFILECOLUMN         | Description     |
      | Columns | LONGCOLUMN          | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.LONGCOLUMN          | Description     |
      | Columns | TIMESTAMP6LTZCOLUMN | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.TIMESTAMP6LTZCOLUMN | Description     |
      | Columns | ROWIDCOLUMN         | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.ROWIDCOLUMN         | Description     |
      | Columns | BINARYFLOATCOLUMN   | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.BINARYFLOATCOLUMN   | Description     |
      | Columns | NUMBERCOLUMN        | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.NUMBERCOLUMN        | Description     |
      | Columns | NCLOBCOLUMN         | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.NCLOBCOLUMN         | Description     |
  ...
  Scenario:SC#6_1_Verify the Dry run feature for the OracleDB Cataloger
    Given user "update" the json file "ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleCataloger_DryRun.json" file for following values
      | jsonPath  | jsonValues | type    |
      | $..dryRun | true       | boolean |
    And Execute REST API with following parameters
      | Header           | Query | Param | type         | url                                                                 | body                                                              | response code | response message | jsonPath                                                    |
      | application/json | raw   | false | Put          | settings/analyzers/OracleDBDataSource                               | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleDataSource.json       | 204           |                  |                                                             |
      |                  |       |       | Get          | settings/analyzers/OracleDBDataSource                               |                                                                   | 200           |                  | Oracle19cPDBDS                                              |
      |                  |       |       | Put          | settings/analyzers/OracleDBCataloger                                | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleCataloger_DryRun.json | 204           |                  |                                                             |
      ...
      |                  |       |       | Post         | extensions/analyzers/start/LocalNode/cataloger/OracleDBCataloger/*  | ida/jdbcAnalyzerPayloads/Oracle18cPDB/empty.json                  | 200           |                  |                                                             |
      |                  |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/* |                                                                   | 200           | IDLE             | $.[?(@.configurationName=='OracleCataloger_DryRun')].status |
  ...
  Scenario:SC#6_2_Verify the Dry run feature for the OracleDB Analyzer
    ...
    Given user "update" the json file "ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleAnalyzer_DryRun.json" file for following values
      | jsonPath  | jsonValues | type    |
      | $..dryRun | true       | boolean |
    And Execute REST API with following parameters
      | Header           | Query | Param | type         | url                                                                   | body                                                              | response code | response message | jsonPath                                                    |
      | application/json | raw   | false | Put          | settings/analyzers/OracleDBDataSource                                 | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleDataSource.json       | 204           |                  |                                                             |
      |                  |       |       | Get          | settings/analyzers/OracleDBDataSource                                 |                                                                   | 200           |                  | Oracle18cPDBDS                                              |
      |                  |       |       | Put          | settings/analyzers/OracleDBCataloger                                  | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleCataloger_DryRun.json | 204           |                  |                                                             |
      |                  |       |       | Get          | settings/analyzers/OracleDBCataloger                                  |                                                                   | 200           |                  | OracleCataloger_DryRun                                      |
      |                  |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/*   |                                                                   | 200           | IDLE             | $.[?(@.configurationName=='OracleCataloger_DryRun')].status |
      |                  |       |       | Post         | extensions/analyzers/start/LocalNode/cataloger/OracleDBCataloger/*    | ida/jdbcAnalyzerPayloads/Oracle18cPDB/empty.json                  | 200           |                  |                                                             |
      |                  |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/*   |                                                                   | 200           | IDLE             | $.[?(@.configurationName=='OracleCataloger_DryRun')].status |
      |                  |       |       | Put          | settings/analyzers/OracleDBAnalyzer                                   | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleAnalyzer_DryRun.json  | 204           |                  |                                                             |
      ...
      |                  |       |       | Post         | extensions/analyzers/start/LocalNode/dataanalyzer/OracleDBAnalyzer/*  | ida/jdbcAnalyzerPayloads/Oracle18cPDB/empty.json                  | 200           |                  |                                                             |
      |                  |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/dataanalyzer/OracleDBAnalyzer/* |                                                                   | 200           | IDLE             | $.[?(@.configurationName=='OracleAnalyzer_DryRun')].status  |
    And User launch browser and traverse to login page
    And user enter credentials for "System Administrator1" role
  ...
  ##6477896##
  Scenario Outline:SC#7_1_Run the Plugin configurations for wrong driver bundle name the Oracle18cPDB Cataloger
    Given endpoint for "<ServiceName>" for "<ServiceUser>" having "<Header>" and query param with "<Query>" "<Param>" for request type "<type>" with url "<url>" and body "<body>" and verify "<response code>" and "<response message>" using "<jsonPath>"
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                 | body                                                                                              | response code | response message                   | jsonPath                                                                |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBDataSource                               | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleDataSourceWithWrongBundleName.json                    | 204           |                                    |                                                                         |
      | IDC         | TestSystemUser | application/json | raw   | false | Get          | settings/analyzers/OracleDBDataSource                               |                                                                                                   | 200           | Oracle18cPDBDSwrongBundleName      |                                                                         |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBCataloger                                | ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/OracleCatalogerWithWrongBundleName.json | 204           |                                    |                                                                         |
  ...
  Scenario Outline:SC#8_1_Run the Plugin configurations for DataSource and run the Oracle18cPDB Cataloger
    Given endpoint for "<ServiceName>" for "<ServiceUser>" having "<Header>" and query param with "<Query>" "<Param>" for request type "<type>" with url "<url>" and body "<body>" and verify "<response code>" and "<response message>" using "<jsonPath>"
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                 | body                                                                                              | response code | response message                   | jsonPath                                                                |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBDataSource                               | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleDataSourceWithWrongDriverName.json                    | 204           |                                    |                                                                         |
      | IDC         | TestSystemUser | application/json | raw   | false | Get          | settings/analyzers/OracleDBDataSource                               |                                                                                                   | 200           | Oracle18cPDBDSwrongDriverName      |                                                                         |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBCataloger                                | ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/OracleCatalogerWithWrongDriverName.json | 204           |                                    |                                                                         |
  ...
  Scenario Outline:SC#9_1_Run the Plugin configurations for DataSource and run the Oracle18cPDB Cataloger
    Given endpoint for "<ServiceName>" for "<ServiceUser>" having "<Header>" and query param with "<Query>" "<Param>" for request type "<type>" with url "<url>" and body "<body>" and verify "<response code>" and "<response message>" using "<jsonPath>"
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                 | body                                                                                                 | response code | response message                      | jsonPath                                                                   |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBDataSource                               | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleDataSourceWithWrongDriverVersion.json                    | 204           |                                       |                                                                            |
      | IDC         | TestSystemUser | application/json | raw   | false | Get          | settings/analyzers/OracleDBDataSource                               |                                                                                                      | 200           | Oracle18cPDBDSwrongDriverVersion      |                                                                            |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBCataloger                                | ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/OracleCatalogerWithWrongDriverVersion.json | 204           |                                       |                                                                            |
  ...
  Scenario Outline:SC#10_1_Run the Plugin configurations for DataSource and run the Oracle18cPDB Cataloger in Internal Node
    Given endpoint for "<ServiceName>" for "<ServiceUser>" having "<Header>" and query param with "<Query>" "<Param>" for request type "<type>" with url "<url>" and body "<body>" and verify "<response code>" and "<response message>" using "<jsonPath>"
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                    | body                                                                                             | response code | response message              | jsonPath                                                           |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBDataSource                                  | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleDataSourceInternalNode.json                          | 204           |                               |                                                                    |
      | IDC         | TestSystemUser | application/json | raw   | false | Get          | settings/analyzers/OracleDBDataSource                                  |                                                                                                  | 200           | Oracle18cPDBDSInternalNode    |                                                                    |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBCataloger                                   | ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/OracleCatalogerInternalNodeConfig.json | 204           |                               |                                                                    |
      ...
      | IDC         | TestSystemUser | application/json | raw   | false | Post         | extensions/analyzers/start/InternalNode/cataloger/OracleDBCataloger/*  | ida/jdbcAnalyzerPayloads/Oracle18cPDB/empty.json                                                 | 200           |                               |                                                                    |
      | IDC         | TestSystemUser | application/json | raw   | false | RecursiveGet | extensions/analyzers/status/InternalNode/cataloger/OracleDBCataloger/* |                                                                                                  | 200           | IDLE                          | $.[?(@.configurationName=='OracleCatalogerInInternalNode')].status |
  ...
  Scenario Outline:SC#11_1_Run the Plugin configurations for Analyzer for Oracle18cPDB in InternalNode
    Given endpoint for "<ServiceName>" for "<ServiceUser>" having "<Header>" and query param with "<Query>" "<Param>" for request type "<type>" with url "<url>" and body "<body>" and verify "<response code>" and "<response message>" using "<jsonPath>"
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                      | body                                                                                            | response code | response message             | jsonPath                                                          |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBAnalyzer                                      | ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/OracleAnalyzerInternalNodeConfig.json | 204           |                              |                                                                   |
      ...
      | IDC         | TestSystemUser | application/json | raw   | false | Post         | extensions/analyzers/start/InternalNode/dataanalyzer/OracleDBAnalyzer/*  | ida/jdbcAnalyzerPayloads/Oracle18cPDB/empty.json                                                | 200           |                              |                                                                   |
      | IDC         | TestSystemUser | application/json | raw   | false | RecursiveGet | extensions/analyzers/status/InternalNode/dataanalyzer/OracleDBAnalyzer/* |                                                                                                 | 200           | IDLE                         | $.[?(@.configurationName=='OracleAnalyzerInInternalNode')].status |
  ...
  Scenario Outline:SC#12_1_Run the Plugin configurations for DataSource and run the Oracle18CPDB Cataloger
    Given endpoint for "<ServiceName>" for "<ServiceUser>" having "<Header>" and query param with "<Query>" "<Param>" for request type "<type>" with url "<url>" and body "<body>" and verify "<response code>" and "<response message>" using "<jsonPath>"
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                 | body                                                                                       | response code | response message            | jsonPath                                                         |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBDataSource                               | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleDataSource.json                                | 204           |                             |                                                                  |
      | IDC         | TestSystemUser | application/json | raw   | false | Get          | settings/analyzers/OracleDBDataSource                               |                                                                                            | 200           | Oracle18cPDBDS              |                                                                  |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBCataloger                                | ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/OracleCatalogerWithNoFilter.json | 204           |                             |                                                                  |
  ...
  Scenario:SC#12_4_Verify the technology tags got assigned to all Oracle DB items like Cluster,Service,Database...etc
    ...
    And user performs "definite facet selection" in "Orc18cPDBCataloger" attribute under "Tags" facets in Item Search results page
    And user performs "facet selection" in "Analysis" attribute under "Metadata Type" facets in Item Search results page
    Then the following tags "Orc18cPDBCataloger,Oracle,Oracle18C_PDB_Cat" should get displayed for the column "cataloger/OracleDBCataloger"
    Then user "verify tag item presence" of technology tags for the below Type and file names
      | catalogName | name         | facet         | Tag                                         | fileName                                               | userTag |
      | Default     | Schema       | Metadata Type | Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat | ORACLE12C_SCHEMA1                                      | Oracle  |
      | Default     | Service      | Metadata Type | Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat | ORACLE:1521                                            | Oracle  |
      | Default     | Database     | Metadata Type | Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat | PDBDB18C.DIQ.QA.ASGINT.LOC                             | Oracle  |
      | Default     | Synonym      | Metadata Type | Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat | STMT_AUDIT_OPTION_MAP                                  | Oracle  |
      | Default     | Column       | Metadata Type | Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat | REGION_NAME                                            | Oracle  |
      | Default     | Table        | Metadata Type | Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat | ORACLE_DIFFDATATYPES                                   | Oracle  |
      | Default     | Index        | Metadata Type | Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat | ORACLEINDEXTEST                                        | Oracle  |
      | Default     | UserRole     | Metadata Type | Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat | AUDIT_ADMIN                                            | Oracle  |
      | Default     | User         | Metadata Type | Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat | ORACLE12C_SCHEMA1                                      | Oracle  |
      | Default     | Constraint   | Metadata Type | Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat | EMP_SALARY_MIN                                         | Oracle  |
      | Default     | Routine      | Metadata Type | Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat | PROT2T                                                 | Oracle  |
      | Default     | Trigger      | Metadata Type | Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat | TRIGGER1                                               | Oracle  |
      | Default     | File         | Metadata Type | Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat | C:\ORACLE\18\APP\ORADATA\ORCL18C\PDBDB18C\SYSTEM01.DBF | Oracle  |
      | Default     | DatabaseLink | Metadata Type | Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat | DBMS_CLRDBLINK                                         | Oracle  |
      | Default     | Sequence     | Metadata Type | Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat | EMPLOYEES_SEQ                                          | Oracle  |
      | Default     | Tablespace   | Metadata Type | Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat | USERS                                                  | Oracle  |
      | Default     | Cluster      | Metadata Type | Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat | diqscanora01v.diq.qa.asgint.loc                        | Oracle  |


  Scenario Outline:SC#13_1_Run the Plugin configurations for Analyzer in Oracle18CPDB
    Given endpoint for "<ServiceName>" for "<ServiceUser>" having "<Header>" and query param with "<Query>" "<Param>" for request type "<type>" with url "<url>" and body "<body>" and verify "<response code>" and "<response message>" using "<jsonPath>"
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                   | body                                                                          | response code | response message | jsonPath                                            |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBAnalyzer                                   | ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/OracleAnalyzer.json | 204           |                  |                                                     |
      ...
      | IDC         | TestSystemUser | application/json | raw   | false | Post         | extensions/analyzers/start/LocalNode/dataanalyzer/OracleDBAnalyzer/*  | ida/jdbcAnalyzerPayloads/Oracle18cPDB/empty.json                              | 200           |                  |                                                     |
      | IDC         | TestSystemUser | application/json | raw   | false | RecursiveGet | extensions/analyzers/status/LocalNode/dataanalyzer/OracleDBAnalyzer/* |                                                                               | 200           | IDLE             | $.[?(@.configurationName=='OracleAnalyzer')].status |
  ...
  Scenario:SC#13_2_Verify the Technology tag appears properly for analysis item added by OracleDBAnalyzer
    ...
    And user performs "definite facet selection" in "Orc18cPDBCataloger" attribute under "Tags" facets in Item Search results page
    And user performs "facet selection" in "Analysis" attribute under "Metadata Type" facets in Item Search results page
    Then the following tags "Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat" should get displayed for the column "cataloger/OracleDBCataloger"
    Then the following tags "Oracle,Orc18cPDBCataloger,Oracle,Oracle18C_PDB_AY" should get displayed for the column "dataanalyzer/OracleDBAnalyzer"
    Then user "verify tag item presence" of technology tags for the below Type and file names
      | catalogName | name   | facet         | Tag                                                                            | fileName             | userTag |
      | Default     | Column | Metadata Type | Oracle,Orc18cPDBCataloger,Orc18cPDBAnalyzer,Oracle18C_PDB_AY,Oracle18C_PDB_Cat | TIMESTAMP6TZCOLUMN   | Oracle  |
      | Default     | Table  | Metadata Type | Oracle,Orc18cPDBCataloger,Orc18cPDBAnalyzer,Oracle18C_PDB_AY,Oracle18C_PDB_Cat | ORACLE_DIFFDATATYPES | Oracle  |
  ...
  Scenario:SC#13_6_Verify the Column with datatype timestamp in Oracle DB which should have the appropriate metadata information in IDC UI and Database for Table and View
    ...
    Then the following metadata values should be displayed
      ...
      | Length                        | 7                   | Statistics  |
      | Maximum value                 | 2020-04-24 08:05:35 | Statistics  |
      | Minimum value                 | 2020-04-24 08:05:35 | Statistics  |
      | Number of non null values     | 4                   | Statistics  |
      | Percentage of non null values | 100                 | Statistics  |
      | Number of null values         | 0                   | Statistics  |
  ...
  Scenario:SC#13_10_Verify the data profiling metadata for string,numeric,date,time,timestamp datatypes metrics does not get calculated for empty table(oracle)
    And User launch browser and traverse to login page
    And user enter credentials for "System Administrator1" role
    And user enters the search text "DOB2" and clicks on search
    And user performs "definite facet selection" in "Orc18cPDBCataloger" attribute under "Tags" facets in Item Search results page
    And user performs "facet selection" in "ORACLE_EMPTY [Table]" attribute under "Hierarchy" facets in Item Search results page
    And user performs "facet selection" in "Column" attribute under "Metadata Type" facets in Item Search results page
...
#      | Last analyzed at   | Lifecycle  |
  ...
  Scenario:SC#13_11_Verify the data profiling metadata for date,time,timestamp datatypes and should have the appropriate metadata information in IDC UI and Database(oracle)
    Given User launch browser and traverse to login page
    And user enter credentials for "System Administrator1" role
    And user enters the search text "DOB" and clicks on search
    And user performs "definite facet selection" in "Orc18cPDBCataloger" attribute under "Tags" facets in Item Search results page
    And user performs "facet selection" in "ORACLE_TABLE [Table]" attribute under "Hierarchy" facets in Item Search results page
    And user performs "facet selection" in "Column" attribute under "Metadata Type" facets in Item Search results page
    ...
    Then the following metadata values should be displayed
      ...
      | Number of unique values       | 1                   | Statistics  |
      | Percentage of unique values   | 100                 | Statistics  |
    And user enters the search text "DOB3" and clicks on search
    And user performs "definite facet selection" in "Orc18cPDBCataloger" attribute under "Tags" facets in Item Search results page
    And user performs "facet selection" in "ORACLE_TABLE [Table]" attribute under "Hierarchy" facets in Item Search results page
    And user performs "facet selection" in "Column" attribute under "Metadata Type" facets in Item Search results page
  ...
  Scenario Outline:SC#14_1_Run the Plugin configurations for DataSource and run the Oracle18CPDB Cataloger
    Given endpoint for "<ServiceName>" for "<ServiceUser>" having "<Header>" and query param with "<Query>" "<Param>" for request type "<type>" with url "<url>" and body "<body>" and verify "<response code>" and "<response message>" using "<jsonPath>"
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                 | body                                                                                           | response code | response message                | jsonPath                                                             |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBDataSource                               | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleDataSource.json                                    | 204           |                                 |                                                                      |
  ...
  Scenario:SC#14_2_Verify Oracle cataloger scans and collects data if schema name alone is provided in filters(Oracle DB)
    ...
    And user connect to the database and execute query for the following parameters
      ...
      | oracle18c_pdb | STRUCTURED   | json/IDA.json | oracle18cPDBQueries | gettablesFromOracle12c_Schema1 | NAME       | returnstringlist | resultsInList |
    And user "verifies" the "Tables" Item view page result "retainslist" value with Postgres DB
    And user connect to the database and execute query for the following parameters
      | dataBaseName  | dataBaseType | queryPath     | queryPage           | queryField                    | columnName | queryOperation   | storeResults  |
      | oracle18c_pdb | STRUCTURED   | json/IDA.json | oracle18cPDBQueries | getviewsFromOracle12c_Schema1 | NAME       | returnstringlist | resultsInList |
    And user "verifies" the "Tables" Item view page result "retainslist" value with Postgres DB
    And user "widget presence" on "Constraints" in Item view page
    And user connect to the database and execute query for the following parameters
      | dataBaseName  | dataBaseType | queryPath     | queryPage           | queryField                     | columnName | queryOperation   | storeResults  |
      | oracle18c_pdb | STRUCTURED   | json/IDA.json | oracle18cPDBQueries | getindexsFromOracle12c_Schema1 | NAME       | returnstringlist | resultsInList |
    And user "verifies" the "has_Index" Item view page result "list" value with Postgres DB
    And user connect to the database and execute query for the following parameters
      | dataBaseName  | dataBaseType | queryPath     | queryPage           | queryField                       | columnName | queryOperation   | storeResults  |
      | oracle18c_pdb | STRUCTURED   | json/IDA.json | oracle18cPDBQueries | gettriggersFromOracle12c_Schema1 | NAME       | returnstringlist | resultsInList |
    And user "verifies" the "has_Trigger" Item view page result "list" value with Postgres DB
    Then user performs click and verify in new window
      | Table  | value              | Action                    | RetainPrevwindow | indexSwitch | filePath                                                    | jsonPath             | metadataSection |
      | Tables | ORACLE_TAG_DETAILS | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.ORACLE_TAG_DETAILS | Description     |
      | Tables | OCPPVIEW           | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.OCPPVIEW           | Description     |
    ...
    And user connect to the database and execute query for the following parameters
      | dataBaseName  | dataBaseType | queryPath     | queryPage           | queryField            | columnName | queryOperation   | storeResults  |
      | oracle18c_pdb | STRUCTURED   | json/IDA.json | oracle18cPDBQueries | gettablesFromHRSchema | NAME       | returnstringlist | resultsInList |
    And user "verifies" the "Tables" Item view page result "list" value with Postgres DB
    And user connect to the database and execute query for the following parameters
      | dataBaseName  | dataBaseType | queryPath     | queryPage           | queryField              | columnName | queryOperation   | storeResults  |
      | oracle18c_pdb | STRUCTURED   | json/IDA.json | oracle18cPDBQueries | getsequenceFromHRSchema | NAME       | returnstringlist | resultsInList |
    And user "verifies" the "has_Sequence" Item view page result "list" value with Postgres DB
    And user connect to the database and execute query for the following parameters
      | dataBaseName  | dataBaseType | queryPath     | queryPage           | queryField            | columnName | queryOperation   | storeResults  |
      | oracle18c_pdb | STRUCTURED   | json/IDA.json | oracle18cPDBQueries | getindexsFromHRSchema | NAME       | returnstringlist | resultsInList |
    And user "verifies" the "has_Index" Item view page result "list" value with Postgres DB
    And user connect to the database and execute query for the following parameters
      | dataBaseName  | dataBaseType | queryPath     | queryPage           | queryField              | columnName | queryOperation   | storeResults  |
      | oracle18c_pdb | STRUCTURED   | json/IDA.json | oracle18cPDBQueries | gettriggersFromHRSchema | NAME       | returnstringlist | resultsInList |
    And user "verifies" the "has_Trigger" Item view page result "list" value with Postgres DB
    Then user performs click and verify in new window
      | Table  | value     | Action               | RetainPrevwindow | indexSwitch | filePath | jsonPath | metadataSection |
  ...
  Scenario Outline:SC#15_1_Run the Plugin configurations for DataSource and run the Oracle18cPDB Cataloger
    Given endpoint for "<ServiceName>" for "<ServiceUser>" having "<Header>" and query param with "<Query>" "<Param>" for request type "<type>" with url "<url>" and body "<body>" and verify "<response code>" and "<response message>" using "<jsonPath>"
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                 | body                                                                                                   | response code | response message                        | jsonPath                                                                     |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBDataSource                               | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleDataSource.json                                            | 204           |                                         |                                                                              |
      | IDC         | TestSystemUser | application/json | raw   | false | Get          | settings/analyzers/OracleDBDataSource                               |                                                                                                        | 200           | Oracle18cPDBDS                          |                                                                              |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBCataloger                                | ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/OracleCatalogerWithSchemaAndTableFilter.json | 204           |                                         |                                                                              |
  ...
  Scenario Outline:SC#16_1_Run the Plugin configurations for DataSource and run the Oracle18cPDB Cataloger
    Given endpoint for "<ServiceName>" for "<ServiceUser>" having "<Header>" and query param with "<Query>" "<Param>" for request type "<type>" with url "<url>" and body "<body>" and verify "<response code>" and "<response message>" using "<jsonPath>"
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                 | body                                                                                                             | response code | response message                                  | jsonPath                                                                               |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBDataSource                               | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleDataSource.json                                                      | 204           |                                                   |                                                                                        |
      | IDC         | TestSystemUser | application/json | raw   | false | Get          | settings/analyzers/OracleDBDataSource                               |                                                                                                                  | 200           | Oracle18cPDBDS                                    |                                                                                        |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBCataloger                                | ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/OracleCatalogerWithMultipleSchemaFilterWithTables.json | 204           |                                                   |                                                                                        |
  ...
  Scenario:SC#16_2_Verify Oracle cataloger scans and collects data if multiple schema names having tables in it are provided in filters(Oracle DB)
    ...
    Then user performs click and verify in new window
      | Table  | value              | Action                    | RetainPrevwindow | indexSwitch | filePath                                                    | jsonPath             | metadataSection |
      | Tables | ORACLE_TAG_DETAILS | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.ORACLE_TAG_DETAILS | Description     |
      | Tables | TABLE_PRIMARY      | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.TABLE_PRIMARY      | Description     |
    And user enters the search text "ORACLE12C_SCHEMA1" and clicks on search
    And user performs "definite facet selection" in "Orc18cPDBCataloger" attribute under "Tags" facets in Item Search results page
    And user performs "facet selection" in "ORACLE12C_SCHEMA1 [Schema]" attribute under "Hierarchy" facets in Item Search results page
    And user performs "facet selection" in "Schema" attribute under "Metadata Type" facets in Item Search results page
    ...
    Then user performs click and verify in new window
      | Table   | value       | Action                    | RetainPrevwindow | indexSwitch | filePath                                                    | jsonPath    | metadataSection |
      | Tables  | BASELINES   | click and verify metadata | Yes              | 0           | ida/jdbcAnalyzerPayloads/Oracle18cPDB/expectedMetadata.json | $.BASELINES | Description     |
  ...
  Scenario Outline:SC#17_1_Run the Plugin configurations for DataSource and run the Oracle18cPDB Cataloger
    Given endpoint for "<ServiceName>" for "<ServiceUser>" having "<Header>" and query param with "<Query>" "<Param>" for request type "<type>" with url "<url>" and body "<body>" and verify "<response code>" and "<response message>" using "<jsonPath>"
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                 | body                                                                                                           | response code | response message                                | jsonPath                                                                             |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBDataSource                               | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleDataSource.json                                                    | 204           |                                                 |                                                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | Get          | settings/analyzers/OracleDBDataSource                               |                                                                                                                | 200           | Oracle18cPDBDS                                  |                                                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBCataloger                                | ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/OracleCatalogerwithSchemaAndMultipleTableFilter.json | 204           |                                                 |                                                                                      |
  ...
  Scenario Outline:SC#18_1_Run the Plugin configurations for DataSource and run the Oracle18cPDB Cataloger
    Given endpoint for "<ServiceName>" for "<ServiceUser>" having "<Header>" and query param with "<Query>" "<Param>" for request type "<type>" with url "<url>" and body "<body>" and verify "<response code>" and "<response message>" using "<jsonPath>"
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                 | body                                                                                                      | response code | response message                           | jsonPath                                                                        |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBDataSource                               | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleDataSource.json                                               | 204           |                                            |                                                                                 |
      | IDC         | TestSystemUser | application/json | raw   | false | Get          | settings/analyzers/OracleDBDataSource                               |                                                                                                           | 200           | Oracle18cPDBDS                             |                                                                                 |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBCataloger                                | ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/OracleCatalogerWithMultipleSchemasInFilter.json | 204           |                                            |                                                                                 |
  ...
  Scenario:SC#18_2_Verify Oracle cataloger scans and collects data if multiple schema name alone is provided in filters
    ...
    And user connect to the database and execute query for the following parameters
      | dataBaseName  | dataBaseType | queryPath     | queryPage           | queryField                       | columnName | queryOperation   | storeResults  |
      | oracle18c_pdb | STRUCTURED   | json/IDA.json | oracle18cPDBQueries | getroutinesFromOracle12c_Schema1 | NAME       | returnstringlist | resultsInList |
  ...
  Scenario Outline:SC#19_1_Run the Plugin configurations for DataSource and run the Oracle18cPDB Cataloger
    Given endpoint for "<ServiceName>" for "<ServiceUser>" having "<Header>" and query param with "<Query>" "<Param>" for request type "<type>" with url "<url>" and body "<body>" and verify "<response code>" and "<response message>" using "<jsonPath>"
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                 | body                                                                                                              | response code | response message                                   | jsonPath                                                                                |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBDataSource                               | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleDataSource.json                                                       | 204           |                                                    |                                                                                         |
      | IDC         | TestSystemUser | application/json | raw   | false | Get          | settings/analyzers/OracleDBDataSource                               |                                                                                                                   | 200           | Oracle18cPDBDS                                     |                                                                                         |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBCataloger                                | ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/OracleCatalogerwithNonExistingSchemaAndTableFilter.json | 204           |                                                    |                                                                                         |
  ...
  Scenario:SC#19_2_Verify Oracle cataloger scans and collects data if non existing schema name and table name are provided in filters(Oracle DB)
    ...
    Then user performs click and verify in new window
      ...
      | index   | SYS_IL0000073524C00015$$ | verify widget contains |                  |             |          |          |                 |
      | index   | SYS_IL0000073524C00016$$ | verify widget contains |                  |             |          |          |                 |
      | index   | SYS_IL0000073524C00017$$ | verify widget contains |                  |             |          |          |                 |
    And user enters the search text "HR" and clicks on search
    And user performs "definite facet selection" in "Orc18cPDBCataloger" attribute under "Tags" facets in Item Search results page
    And user performs "facet selection" in "HR [Schema]" attribute under "Hierarchy" facets in Item Search results page
    And user performs "facet selection" in "Schema" attribute under "Metadata Type" facets in Item Search results page
  ...
  Scenario Outline:SC#20_1_Run the Plugin configurations for DataSource and run the Oracle18cPDB Cataloger
    Given endpoint for "<ServiceName>" for "<ServiceUser>" having "<Header>" and query param with "<Query>" "<Param>" for request type "<type>" with url "<url>" and body "<body>" and verify "<response code>" and "<response message>" using "<jsonPath>"
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                 | body                                                                                                   | response code | response message                        | jsonPath                                                                     |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBDataSource                               | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleDataSource.json                                            | 204           |                                         |                                                                              |
      | IDC         | TestSystemUser | application/json | raw   | false | Get          | settings/analyzers/OracleDBDataSource                               |                                                                                                        | 200           | Oracle18cPDBDS                          |                                                                              |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBCataloger                                | ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/OracleCatalogerWithIncorrectCredentials.json | 204           |                                         |                                                                              |
  ...
  Scenario Outline:SC#21_1_Run the Plugin configurations for DataSource and run the Oracle18cPDB Cataloger
    Given endpoint for "<ServiceName>" for "<ServiceUser>" having "<Header>" and query param with "<Query>" "<Param>" for request type "<type>" with url "<url>" and body "<body>" and verify "<response code>" and "<response message>" using "<jsonPath>"
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                 | body                                                                                  | response code | response message       | jsonPath                                                    |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBDataSource                               | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleDataSourceWithWrongDBinURL.json           | 204           |                        |                                                             |
      | IDC         | TestSystemUser | application/json | raw   | false | Get          | settings/analyzers/OracleDBDataSource                               |                                                                                       | 200           | Oracle18cPDBDSwrongDB  |                                                             |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBCataloger                                | ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/OracleCatalogerWrongDB.json | 204           |                        |                                                             |
  ...
  Scenario Outline:SC#22_1_Run the Plugin configurations for DataSource and run the Oracle18cPDB Cataloger
    Given endpoint for "<ServiceName>" for "<ServiceUser>" having "<Header>" and query param with "<Query>" "<Param>" for request type "<type>" with url "<url>" and body "<body>" and verify "<response code>" and "<response message>" using "<jsonPath>"
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                 | body                                                                                    | response code | response message         | jsonPath                                                      |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBDataSource                               | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleDataSourceWrongHost.json                    | 204           |                          |                                                               |
      | IDC         | TestSystemUser | application/json | raw   | false | Get          | settings/analyzers/OracleDBDataSource                               |                                                                                         | 200           | Oracle18cPDBDSwrongHost  |                                                               |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBCataloger                                | ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/OracleCatalogerWrongHost.json | 204           |                          |                                                               |
  ...
  Scenario Outline:SC#23_1_Run the Plugin configurations for DataSource and run the Oracle18CPDB Cataloger
    Given endpoint for "<ServiceName>" for "<ServiceUser>" having "<Header>" and query param with "<Query>" "<Param>" for request type "<type>" with url "<url>" and body "<body>" and verify "<response code>" and "<response message>" using "<jsonPath>"
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                   | body                                                                                                   | response code | response message                        | jsonPath                                                                     |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBDataSource                                 | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleDataSource.json                                            | 204           |                                         |                                                                              |
      ...
      | IDC         | TestSystemUser | application/json | raw   | false | Post         | extensions/analyzers/start/LocalNode/cataloger/OracleDBCataloger/*    | ida/jdbcAnalyzerPayloads/Oracle18cPDB/empty.json                                                       | 200           |                                         |                                                                              |
      | IDC         | TestSystemUser | application/json | raw   | false | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/*   |                                                                                                        | 200           | IDLE                                    | $.[?(@.configurationName=='OracleCatalogerWithSchemaAndTableFilter')].status |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBAnalyzer                                   | ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/OracleAnalyzerWithMinSampleDataCount.json    | 204           |                                         |                                                                              |
  ...
  Scenario Outline:SC#26_1_Run the OracleDB Cataloger and Oracle Analyzer with Schema Filter
    ...
    Examples:
      ...
      | IDC         | TestSystemUser | application/json | raw   | false | Post         | extensions/analyzers/start/LocalNode/cataloger/OracleDBCataloger/*    | ida/jdbcAnalyzerPayloads/Oracle18cPDB/empty.json                                                          | 200           |                                            |                                                                                 |
      | IDC         | TestSystemUser | application/json | raw   | false | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/*   |                                                                                                           | 200           | IDLE                                       | $.[?(@.configurationName=='OracleCatalogerWithMultipleSchemasInFilter')].status |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBAnalyzer                                   | ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/OracleAnalyzerWithSchemaFilter.json             | 204           |                                            |                                                                                 |
  ...
  Scenario Outline:SC#27_1_Run the OracleDB Cataloger and Oracle Analyzer with Schema and Table Filter
    ...
    Examples:
      ...
      | IDC         | TestSystemUser | application/json | raw   | false | Post         | extensions/analyzers/start/LocalNode/cataloger/OracleDBCataloger/*    | ida/jdbcAnalyzerPayloads/Oracle18cPDB/empty.json                                                      | 200           |                                        |                                                                             |
      | IDC         | TestSystemUser | application/json | raw   | false | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/*   |                                                                                                       | 200           | IDLE                                   | $.[?(@.configurationName=='OracleCatalogerWithSchemaFilter')].status        |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBAnalyzer                                   | ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/OracleAnalyzerWithSchemaAndTableFilter.json | 204           |                                        |                                                                             |
  ...
  Scenario Outline:SC#28_1_Run the OracleDB Cataloger and Oracle Analyzer with Multiple Schema and Table Filter
    ...
    Examples:
      ...
      | IDC         | TestSystemUser | application/json | raw   | false | Post         | extensions/analyzers/start/LocalNode/cataloger/OracleDBCataloger/*    | ida/jdbcAnalyzerPayloads/Oracle18cPDB/empty.json                                                              | 200           |                                                |                                                                                     |
      | IDC         | TestSystemUser | application/json | raw   | false | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/*   |                                                                                                               | 200           | IDLE                                           | $.[?(@.configurationName=='OracleCatalogerWithMultipleSchemasInFilter')].status     |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBAnalyzer                                   | ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/OracleAnalyzerWithMultipleSchemaAndTableFilter.json | 204           |                                                |                                                                                     |
  ...
  Scenario:SC#28_4_Verify the Logging enhancement in OracleDB Cataloger and Analyzer
    ...
    Then Analysis log "cataloger/OracleDBCataloger/OracleCatalogerWithMultipleSchemasInFilter%" should display below info/error/warning
      | type | logValue                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | logCode       | pluginName        | removableText  |
      | INFO | Plugin started                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | ANALYSIS-0019 |                   |                |
      | INFO | Plugin Name:OracleDBCataloger, Plugin Type:cataloger, Plugin Version:1.1.0.RC2-SNAPSHOT, Node Name:LocalNode, Host Name:ecd82a87b6c8, Plugin Configuration name:OracleCatalogerWithMultipleSchemasInFilter                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | ANALYSIS-0071 | OracleDBCataloger | Plugin Version |
      | INFO | Plugin OracleDBCataloger Configuration: --- 2020-10-11 07:01:04.204 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: name: "OracleCatalogerWithMultipleSchemasInFilter" 2020-10-11 07:01:04.204 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: pluginVersion: "LATEST" 2020-10-11 07:01:04.204 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: label: 2020-10-11 07:01:04.204 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: : "" 2020-10-11 07:01:04.204 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: catalogName: "Default" 2020-10-11 07:01:04.204 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: eventClass: null 2020-10-11 07:01:04.204 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: eventCondition: null 2020-10-11 07:01:04.204 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: nodeCondition: "name==\"LocalNode\"" 2020-10-11 07:01:04.204 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: maxWorkSize: 100 2020-10-11 07:01:04.204 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: tags: 2020-10-11 07:01:04.204 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: - "Orc18cPDBCataloger" 2020-10-11 07:01:04.204 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: pluginType: "cataloger" 2020-10-11 07:01:04.204 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: dataSource: "Oracle18cPDBDS" 2020-10-11 07:01:04.204 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: credential: "Oracle18cPDBCredentials" 2020-10-11 07:01:04.205 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: businessApplicationName: null 2020-10-11 07:01:04.205 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: dryRun: false 2020-10-11 07:01:04.205 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: schedule: null 2020-10-11 07:01:04.205 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: filter: null 2020-10-11 07:01:04.205 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: pluginName: "OracleDBCataloger" 2020-10-11 07:01:04.205 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: schemas: 2020-10-11 07:01:04.205 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: - schema: "ORACLE12C_SCHEMA1" 2020-10-11 07:01:04.205 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: tables: [] 2020-10-11 07:01:04.205 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: - schema: "ORACLE12C_SCHEMA2" 2020-10-11 07:01:04.205 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: tables: [] 2020-10-11 07:01:04.205 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: arguments: [] 2020-10-11 07:01:04.205 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: type: "Cataloger" 2020-10-11 07:01:04.205 INFO - ANALYSIS-0073: Plugin OracleDBCataloger Configuration: properties: [] | ANALYSIS-0073 | OracleDBCataloger |                |
      | INFO | Plugin OracleDBCataloger Start Time:2020-07-27 13:30:48.336, End Time:2020-07-27 13:31:49.279, Processed Count:2, Errors:0, Warnings:0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | ANALYSIS-0072 | OracleDBCataloger |                |
      | INFO | Plugin completed (elapsed time in (HH:MM:SS.ms): 00:01:38.361)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | ANALYSIS-0020 |                   |                |
    And user enters the search text "Orc18cPDBAnalyzer" and clicks on search
    And user performs "facet selection" in "Orc18cPDBAnalyzer" attribute under "Tags" facets in Item Search results page
    And user performs "facet selection" in "Analysis" attribute under "Metadata Type" facets in Item Search results page
    ...
    Then Analysis log "dataanalyzer/OracleDBAnalyzer/OracleAnalyzerWithMultipleSchemaAndTableFilter%" should display below info/error/warning
      | type | logValue                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | logCode       | pluginName       | removableText  |
      | INFO | Plugin started                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | ANALYSIS-0019 |                  |                |
      | INFO | Plugin Name:OracleDBAnalyzer, Plugin Type:dataanalyzer, Plugin Version:1.1.0.RC2-SNAPSHOT, Node Name:LocalNode, Host Name:ecd82a87b6c8, Plugin Configuration name:OracleAnalyzerWithMultipleSchemaAndTableFilter                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | ANALYSIS-0071 | OracleDBAnalyzer | Plugin Version |
      | INFO | Plugin OracleDBAnalyzer Configuration: --- 2020-10-11 07:01:56.394 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: name: "OracleAnalyzerWithMultipleSchemaAndTableFilter" 2020-10-11 07:01:56.394 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: pluginVersion: "LATEST" 2020-10-11 07:01:56.394 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: label: 2020-10-11 07:01:56.394 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: : "" 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: catalogName: "Default" 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: eventClass: null 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: eventCondition: null 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: nodeCondition: "name==\"LocalNode\"" 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: maxWorkSize: 100 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: tags: 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: - "Orc18cPDBAnalyzer" 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: pluginType: "dataanalyzer" 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: dataSource: null 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: credential: null 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: businessApplicationName: null 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: dryRun: false 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: schedule: null 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: filter: null 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: histogramBuckets: 100 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: database: "PDBDB18C.DIQ.QA.ASGINT.LOC" 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: pluginName: "OracleDBAnalyzer" 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: sampleDataCount: 25 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: schemas: 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: - schema: "ORACLE12C_SCHEMA1" 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: tables: 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: - table: "ORACLE_TAG_DETAILS" 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: - table: "ORACLE_TABLE" 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: - table: "OCPPVIEW" 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: - table: "ORACLE_VIEW" 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: - schema: "ORACLE12C_SCHEMA2" 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: tables: 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: - table: "ORACLE_TABLE2" 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: - table: "ORACLE_VIEW2" 2020-10-11 07:01:56.395 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: type: "Dataanalyzer" 2020-10-11 07:01:56.396 INFO - ANALYSIS-0073: Plugin OracleDBAnalyzer Configuration: topValues: 10 | ANALYSIS-0073 | OracleDBAnalyzer |                |
      | INFO | Plugin OracleDBAnalyzer Start Time:2020-07-27 13:32:35.238, End Time:2020-07-27 13:32:41.469, Processed Count:2, Errors:0, Warnings:0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | ANALYSIS-0072 | OracleDBAnalyzer |                |
      | INFO | Plugin completed (elapsed time in (HH:MM:SS.ms): 00:00:00.264)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | ANALYSIS-0020 |                  |                |


  @webtest @positive
  Scenario:SC#28_5_Verify the OracleDB Analyzer plugin Processed items
    Given User launch browser and traverse to login page
    And user enter credentials for "System Administrator1" role
    And user enters the search text "Orc18cPDBAnalyzer" and clicks on search
    And user performs "facet selection" in "Orc18cPDBAnalyzer" attribute under "Tags" facets in Item Search results page
  ...
  Scenario Outline:SC#29_1_Run the OracleDB Cataloger and Oracle Analyzer with Non Existing Schema and Table Filter
    ...
    Examples:
      ...
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBDataSource                                 | ida/jdbcAnalyzerPayloads/Oracle18cPDB/OracleDataSource.json                                                       | 204           |                                                    |                                                                                         |
      | IDC         | TestSystemUser | application/json | raw   | false | Get          | settings/analyzers/OracleDBDataSource                                 |                                                                                                                   | 200           | Oracle18cPDBDS                                     |                                                                                         |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBCataloger                                  | ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/OracleCatalogerWithSchemaAndTableAndViewFilter.json     | 204           |                                                    |                                                                                         |
      ...
      | IDC         | TestSystemUser | application/json | raw   | false | Post         | extensions/analyzers/start/LocalNode/cataloger/OracleDBCataloger/*    | ida/jdbcAnalyzerPayloads/Oracle18cPDB/empty.json                                                                  | 200           |                                                    |                                                                                         |
      | IDC         | TestSystemUser | application/json | raw   | false | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/*   |                                                                                                                   | 200           | IDLE                                               | $.[?(@.configurationName=='OracleCatalogerWithSchemaAndTableAndViewFilter')].status     |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBAnalyzer                                   | ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/OracleAnalyzerWithnNonExistingSchemaAndTableFilter.json | 204           |                                                    |                                                                                         |
  ...
  ##7072921##
  @webtest
  Scenario:SC#29_2_verify data sampling and data profiling (varchar, decimal and Timestamp)does not happen for Table and View When Non Existing schema and Table name provided in OracleDBAnalyzer Filter
    Given User launch browser and traverse to login page
    And user enter credentials for "System Administrator1" role
  ...
  Scenario Outline:SC#30_1_Run the OracleDB Cataloger and Oracle Analyzer With Incorrect Database Name in OracleDBAnalyzer
    ...
    Examples:
      ...
      | IDC         | TestSystemUser | application/json | raw   | false | Post         | extensions/analyzers/start/LocalNode/cataloger/OracleDBCataloger/*    | ida/jdbcAnalyzerPayloads/Oracle18cPDB/empty.json                                                              | 200           |                                                |                                                                                     |
      | IDC         | TestSystemUser | application/json | raw   | false | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/*   |                                                                                                               | 200           | IDLE                                           | $.[?(@.configurationName=='OracleCatalogerWithSchemaAndTableAndViewFilter')].status |
      | IDC         | TestSystemUser | application/json | raw   | false | Put          | settings/analyzers/OracleDBAnalyzer                                   | ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/OracleAnalyzerWithIncorrectDatabaseName.json        | 204           |                                                |                                                                                     |
...
########################################################## PII Tags ################################################################################
  ...
  Scenario Outline:SC#31_1_Create OracleDB Plugin config and start it
    ...
    Examples:
      ...
      | IDC         | TestSystemUser | application/json |       |       | Put          | tags/Default/structures                                                              | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/policyEngine/OraclePIITags.json                          | $.PIIConfig      | 200           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Put          | policy/tagging/actions                                                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/policyEngine/OracleDBTag.json                            | $.SC33           | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Put          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/Oracle18CPDBCatalogerTagsConfig.json | $.CatalogConfig  | 204           |                   |                                                        |
      ...
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger  |                                                                                                         |                  | 200           | IDLE              | $.[?(@.configurationName=='OracleDBCataloger')].status |
      | IDC         | TestSystemUser | application/json |       |       | Put          | settings/analyzers/OracleDBAnalyzer/OracleDBAnalyzer                                 | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/Oracle18CPDBAnalyzerTagsConfig.json  | $.AnalyzerConfig | 204           |                   |                                                        |
  ...
  Scenario:SC#31_2_Verify Tag is set for the column when typePattern(String) and dataPattern/minimumRatio matches with the column type/value ratio in Oracle table.
    ...
    Then user "verify tag item presence" of technology tags for the below Type and file names
      | catalogName | name              | facet | Tag                                                                                          | fileName  | userTag             |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,Email Address | EMAIL     | TAGDETAILS_ALLMATCH |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,Gender        | GENDER    | TAGDETAILS_ALLMATCH |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,IP Address    | IPADDRESS | TAGDETAILS_ALLMATCH |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,SSN           | SSN       | TAGDETAILS_ALLMATCH |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,Full Name     | FULL_NAME | TAGDETAILS_ALLMATCH |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,Email Address | EMAIL     | TAGDETAILS_ALLEMPTY |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,SSN           | SSN       | TAGDETAILS_ALLEMPTY |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,IP Address    | IPADDRESS | TAGDETAILS_ALLEMPTY |
  ...
  Scenario Outline:SC#33_1_Create OracleDB Plugin config and start it
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                                  | bodyFile                                                                                                | path             | response code | response message  | jsonPath                                               |
      | IDC         | TestSystemUser | application/json |       |       | Put          | policy/tagging/actions                                                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/policyEngine/OracleDBTag.json                            | $.SC35           | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Put          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/Oracle18CPDBCatalogerTagsConfig.json | $.CatalogConfig  | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Get          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               |                                                                                                         |                  | 200           | OracleDBCataloger |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger  |                                                                                                         |                  | 200           | IDLE              | $.[?(@.configurationName=='OracleDBCataloger')].status |
      | IDC         | TestSystemUser | application/json |       |       | Post         | extensions/analyzers/start/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger   |                                                                                                         |                  | 200           |                   |                                                        |
  ...
  Scenario:SC#33_2_Verify Tag is set for the column when namePattern and dataPattern/minimumRatio matches with the column name/value ratio in Oracle table.
    ...
    Then user "verify tag item presence" of technology tags for the below Type and file names
      | catalogName | name              | facet | Tag                                                                                         | fileName  | userTag                                     |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,EmailPII     | EMAIL     | TAGDETAILS_Ratiogreaterthan05EmptyFalseTrue |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,GenderPII    | GENDER    | TAGDETAILS_Ratiogreaterthan05EmptyFalseTrue |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,IPAddressPII | IPADDRESS | TAGDETAILS_Ratiogreaterthan05EmptyFalseTrue |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,SSNPII       | SSN       | TAGDETAILS_Ratiogreaterthan05EmptyFalseTrue |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,FullNamePII  | FULL_NAME | TAGDETAILS_Ratiogreaterthan05EmptyFalseTrue |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,EmailPII     | EMAIL     | TAGDETAILS_RatioEqualTo05EmptyFalse         |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,GenderPII    | GENDER    | TAGDETAILS_RatioEqualTo05EmptyFalse         |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,IPAddressPII | IPADDRESS | TAGDETAILS_RatioEqualTo05EmptyFalse         |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,SSNPII       | SSN       | TAGDETAILS_RatioEqualTo05EmptyFalse         |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,FullNamePII  | FULL_NAME | TAGDETAILS_RatioEqualTo05EmptyFalse         |
  ...
  Scenario Outline:SC#35_1_Create OracleDB Plugin config and start it
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                                  | bodyFile                                                                                                | path      | response code | response message  | jsonPath                                               |
      | IDC         | TestSystemUser | application/json |       |       | Put          | policy/tagging/actions                                                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/policyEngine/OracleDBTag.json                            | $.SC37    | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Put          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/Oracle18CPDBCatalogerTagsConfig.json | $.Filter1 | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Get          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               |                                                                                                         |           | 200           | OracleDBCataloger |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger  |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBCataloger')].status |
      | IDC         | TestSystemUser | application/json |       |       | Post         | extensions/analyzers/start/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger   |                                                                                                         |           | 200           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger  |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBCataloger')].status |
      | IDC         | TestSystemUser | application/json |       |       | Put          | settings/analyzers/OracleDBAnalyzer/OracleDBAnalyzer                                 | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/Oracle18CPDBAnalyzerTagsConfig.json  | $.Filter1 | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Get          | settings/analyzers/OracleDBAnalyzer/OracleDBAnalyzer                                 |                                                                                                         |           | 200           | OracleDBAnalyzer  |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBAnalyzer')].status  |
      | IDC         | TestSystemUser | application/json |       |       | Post         | extensions/analyzers/start/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer  |                                                                                                         |           | 200           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBAnalyzer')].status  |
  ...
  (Ex: 0.2 - 2 or more rows should have matching column values)- Match Empty is False
    ...
    Then user "verify tag item presence" of technology tags for the below Type and file names
      | catalogName | name              | facet | Tag                                                                                          | fileName  | userTag                              |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,Email Address | EMAIL     | TAGDETAILS_Ratiolessthan05EmptyFalse |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,Gender        | GENDER    | TAGDETAILS_Ratiolessthan05EmptyFalse |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,IP Address    | IPADDRESS | TAGDETAILS_Ratiolessthan05EmptyFalse |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,SSN           | SSN       | TAGDETAILS_Ratiolessthan05EmptyFalse |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,Full Name     | FULL_NAME | TAGDETAILS_Ratiolessthan05EmptyFalse |
  ...
  Scenario Outline:SC#36_1_Create OracleDB Plugin config and start it
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                                  | bodyFile                                                                                                | path      | response code | response message  | jsonPath                                               |
      | IDC         | TestSystemUser | application/json |       |       | Put          | policy/tagging/actions                                                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/policyEngine/OracleDBTag.json                            | $.SC38    | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Put          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/Oracle18CPDBCatalogerTagsConfig.json | $.Filter2 | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Get          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               |                                                                                                         |           | 200           | OracleDBCataloger |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger  |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBCataloger')].status |
      | IDC         | TestSystemUser | application/json |       |       | Post         | extensions/analyzers/start/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger   |                                                                                                         |           | 200           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger  |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBCataloger')].status |
      | IDC         | TestSystemUser | application/json |       |       | Put          | settings/analyzers/OracleDBAnalyzer/OracleDBAnalyzer                                 | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/Oracle18CPDBAnalyzerTagsConfig.json  | $.Filter2 | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Get          | settings/analyzers/OracleDBAnalyzer/OracleDBAnalyzer                                 |                                                                                                         |           | 200           | OracleDBAnalyzer  |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBAnalyzer')].status  |
      | IDC         | TestSystemUser | application/json |       |       | Post         | extensions/analyzers/start/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer  |                                                                                                         |           | 200           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBAnalyzer')].status  |
  ...
  (Ex: 0.6 - 6 or more rows should have matcning column values including empty) - Match Empty is False -10 rows , 3 rows empty, 4 rows match,3 rows does not match
    ...
    Then user "verify tag item non presence" of technology tags for the below Type and file names
      | catalogName | name              | facet | Tag       | fileName  | userTag                                     |
      | Default     | Orc18cPDBAnalyzer | Tags  | SSN       | SSN       | TAGDETAILS_Ratiogreaterthan05EmptyFalseTrue |
      | Default     | Orc18cPDBAnalyzer | Tags  | Gender    | GENDER    | TAGDETAILS_Ratiogreaterthan05EmptyFalseTrue |
      | Default     | Orc18cPDBAnalyzer | Tags  | Full Name | FULL_NAME | TAGDETAILS_Ratiogreaterthan05EmptyFalseTrue |
    Then user "verify tag item presence" of technology tags for the below Type and file names
      | catalogName | name              | facet | Tag                                                                                          | fileName  | userTag                                     |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,Email Address | EMAIL     | TAGDETAILS_Ratiogreaterthan05EmptyFalseTrue |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,IP Address    | IPADDRESS | TAGDETAILS_Ratiogreaterthan05EmptyFalseTrue |
  ...
  Scenario Outline:SC#37_1_Create OracleDB Plugin config and start it
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                                  | bodyFile                                                                                                | path      | response code | response message  | jsonPath                                               |
      | IDC         | TestSystemUser | application/json |       |       | Put          | policy/tagging/actions                                                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/policyEngine/OracleDBTag.json                            | $.SC39    | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBAnalyzer')].status  |
      | IDC         | TestSystemUser | application/json |       |       | Post         | extensions/analyzers/start/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer  |                                                                                                         |           | 200           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBAnalyzer')].status  |
  ...
  (Ex: 0.6 - 6 or more rows should have matcning column values including empty) - Match Empty is True -10 rows , 3 rows empty, 4 rows match,3 rows does not match
    ...
    Then user "verify tag item presence" of technology tags for the below Type and file names
      | catalogName | name              | facet | Tag                                                                                          | fileName  | userTag                                     |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,Email Address | EMAIL     | TAGDETAILS_Ratiogreaterthan05EmptyFalseTrue |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,Gender        | GENDER    | TAGDETAILS_Ratiogreaterthan05EmptyFalseTrue |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,IP Address    | IPADDRESS | TAGDETAILS_Ratiogreaterthan05EmptyFalseTrue |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,SSN           | SSN       | TAGDETAILS_Ratiogreaterthan05EmptyFalseTrue |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,Full Name     | FULL_NAME | TAGDETAILS_Ratiogreaterthan05EmptyFalseTrue |
  ...
  Scenario Outline:SC#38_1_Create OracleDB Plugin config and start it
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                                  | bodyFile                                                                                                | path      | response code | response message  | jsonPath                                               |
      | IDC         | TestSystemUser | application/json |       |       | Put          | policy/tagging/actions                                                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/policyEngine/OracleDBTag.json                            | $.SC40    | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Put          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/Oracle18CPDBCatalogerTagsConfig.json | $.Filter3 | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Get          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               |                                                                                                         |           | 200           | OracleDBCataloger |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger  |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBCataloger')].status |
      | IDC         | TestSystemUser | application/json |       |       | Post         | extensions/analyzers/start/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger   |                                                                                                         |           | 200           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger  |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBCataloger')].status |
      | IDC         | TestSystemUser | application/json |       |       | Put          | settings/analyzers/OracleDBAnalyzer/OracleDBAnalyzer                                 | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/Oracle18CPDBAnalyzerTagsConfig.json  | $.Filter3 | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Get          | settings/analyzers/OracleDBAnalyzer/OracleDBAnalyzer                                 |                                                                                                         |           | 200           | OracleDBAnalyzer  |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBAnalyzer')].status  |
      | IDC         | TestSystemUser | application/json |       |       | Post         | extensions/analyzers/start/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer  |                                                                                                         |           | 200           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBAnalyzer')].status  |
  ...
  Scenario Outline:SC#39_1_Create OracleDB Plugin config and start it
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                                  | bodyFile                                                                                                | path      | response code | response message  | jsonPath                                               |
      | IDC         | TestSystemUser | application/json |       |       | Put          | policy/tagging/actions                                                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/policyEngine/OracleDBTag.json                            | $.SC41    | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Put          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/Oracle18CPDBCatalogerTagsConfig.json | $.Filter4 | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Get          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               |                                                                                                         |           | 200           | OracleDBCataloger |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger  |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBCataloger')].status |
      | IDC         | TestSystemUser | application/json |       |       | Post         | extensions/analyzers/start/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger   |                                                                                                         |           | 200           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger  |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBCataloger')].status |
      | IDC         | TestSystemUser | application/json |       |       | Put          | settings/analyzers/OracleDBAnalyzer/OracleDBAnalyzer                                 | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/Oracle18CPDBAnalyzerTagsConfig.json  | $.Filter4 | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Get          | settings/analyzers/OracleDBAnalyzer/OracleDBAnalyzer                                 |                                                                                                         |           | 200           | OracleDBAnalyzer  |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBAnalyzer')].status  |
      | IDC         | TestSystemUser | application/json |       |       | Post         | extensions/analyzers/start/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer  |                                                                                                         |           | 200           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBAnalyzer')].status  |
  ...
  (Ex: 0.5 - 5 or more rows should have matching column values) - Match Empty is false.
    ...
    Then user "verify tag item presence" of technology tags for the below Type and file names
      | catalogName | name              | facet | Tag                                                                                          | fileName  | userTag                             |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,Email Address | EMAIL     | TAGDETAILS_RatioEqualTo05EmptyFalse |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,Gender        | GENDER    | TAGDETAILS_RatioEqualTo05EmptyFalse |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,IP Address    | IPADDRESS | TAGDETAILS_RatioEqualTo05EmptyFalse |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,SSN           | SSN       | TAGDETAILS_RatioEqualTo05EmptyFalse |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,Full Name     | FULL_NAME | TAGDETAILS_RatioEqualTo05EmptyFalse |
  ...
  Scenario Outline:SC#40_1_Create OracleDB Plugin config and start it
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                                  | bodyFile                                                                                                | path      | response code | response message  | jsonPath                                               |
      | IDC         | TestSystemUser | application/json |       |       | Put          | policy/tagging/actions                                                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/policyEngine/OracleDBTag.json                            | $.SC42    | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Put          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/Oracle18CPDBCatalogerTagsConfig.json | $.Filter1 | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Get          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               |                                                                                                         |           | 200           | OracleDBCataloger |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger  |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBCataloger')].status |
      | IDC         | TestSystemUser | application/json |       |       | Post         | extensions/analyzers/start/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger   |                                                                                                         |           | 200           |                   |                                                        |
  ...
  Scenario Outline:SC#41_1_Create OracleDB Plugin config and start it
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                                  | bodyFile                                                                                                | path             | response code | response message  | jsonPath                                               |
      | IDC         | TestSystemUser | application/json |       |       | Put          | policy/tagging/actions                                                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/policyEngine/OracleDBTag.json                            | $.SC43           | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Put          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/Oracle18CPDBCatalogerTagsConfig.json | $.CatalogConfig  | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Get          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               |                                                                                                         |                  | 200           | OracleDBCataloger |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger  |                                                                                                         |                  | 200           | IDLE              | $.[?(@.configurationName=='OracleDBCataloger')].status |
      | IDC         | TestSystemUser | application/json |       |       | Post         | extensions/analyzers/start/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger   |                                                                                                         |                  | 200           |                   |                                                        |
  ...
  Scenario Outline:SC#44_1_Create OracleDB Plugin config and start it
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                                  | bodyFile                                                                                                | path      | response code | response message  | jsonPath                                               |
      | IDC         | TestSystemUser | application/json |       |       | Put          | policy/tagging/actions                                                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/policyEngine/OracleDBTag.json                            | $.SC46    | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Put          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/Oracle18CPDBCatalogerTagsConfig.json | $.Filter6 | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Get          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               |                                                                                                         |           | 200           | OracleDBCataloger |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger  |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBCataloger')].status |
      | IDC         | TestSystemUser | application/json |       |       | Post         | extensions/analyzers/start/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger   |                                                                                                         |           | 200           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger  |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBCataloger')].status |
      | IDC         | TestSystemUser | application/json |       |       | Put          | settings/analyzers/OracleDBAnalyzer/OracleDBAnalyzer                                 | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/Oracle18CPDBAnalyzerTagsConfig.json  | $.Filter6 | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Get          | settings/analyzers/OracleDBAnalyzer/OracleDBAnalyzer                                 |                                                                                                         |           | 200           | OracleDBAnalyzer  |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBAnalyzer')].status  |
      | IDC         | TestSystemUser | application/json |       |       | Post         | extensions/analyzers/start/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer  |                                                                                                         |           | 200           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBAnalyzer')].status  |
  ...
  Scenario Outline:SC#45_1_Create OracleDB Plugin config and start it
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                                  | bodyFile                                                                                                | path      | response code | response message  | jsonPath                                               |
      | IDC         | TestSystemUser | application/json |       |       | Put          | policy/tagging/actions                                                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/policyEngine/OracleDBTag.json                            | $.SC47    | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Put          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/Oracle18CPDBCatalogerTagsConfig.json | $.Filter5 | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Get          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               |                                                                                                         |           | 200           | OracleDBCataloger |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger  |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBCataloger')].status |
      | IDC         | TestSystemUser | application/json |       |       | Post         | extensions/analyzers/start/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger   |                                                                                                         |           | 200           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger  |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBCataloger')].status |
      | IDC         | TestSystemUser | application/json |       |       | Put          | settings/analyzers/OracleDBAnalyzer/OracleDBAnalyzer                                 | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/Oracle18CPDBAnalyzerTagsConfig.json  | $.Filter5 | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Get          | settings/analyzers/OracleDBAnalyzer/OracleDBAnalyzer                                 |                                                                                                         |           | 200           | OracleDBAnalyzer  |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBAnalyzer')].status  |
      | IDC         | TestSystemUser | application/json |       |       | Post         | extensions/analyzers/start/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer  |                                                                                                         |           | 200           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBAnalyzer')].status  |
  ...
  (Ex: 0.6 - 6 or more rows should have matcning column values - dataPattern and minimumRatio passed).
    ...
    Then user "verify tag item non presence" of technology tags for the below Type and file names
      | catalogName | name              | facet | Tag       | fileName | userTag                                    |
      | Default     | Orc18cPDBAnalyzer | Tags  | FullMatch | COMMENTS | TAGDETAILS_Ratiogreaterthan05MatchFullTrue |
  ...
  Scenario Outline:SC#45_4_Create OracleDB Plugin config and start it
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                                  | bodyFile                                                                                                | path      | response code | response message  | jsonPath                                               |
      | IDC         | TestSystemUser | application/json |       |       | Put          | policy/tagging/actions                                                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/policyEngine/OracleDBTag.json                            | $.SC47_1  | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBAnalyzer')].status  |
      | IDC         | TestSystemUser | application/json |       |       | Post         | extensions/analyzers/start/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer  |                                                                                                         |           | 200           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBAnalyzer')].status  |
  ...
  (Ex: 0.6 - 6 or more rows should have matcning column values - dataPattern and minimumRatio passed).
    ...
    Then user "verify tag item presence" of technology tags for the below Type and file names
      | catalogName | name              | facet | Tag                                                                                      | fileName | userTag                                    |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,FullMatch | COMMENTS | TAGDETAILS_Ratiogreaterthan05MatchFullTrue |
  ...
  Scenario Outline:SC#46_1_Create OracleDB Plugin config and start it
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                                  | bodyFile                                                                                                | path      | response code | response message  | jsonPath                                               |
      | IDC         | TestSystemUser | application/json |       |       | Put          | policy/tagging/actions                                                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/policyEngine/OracleDBTag.json                            | $.SC48    | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Put          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/Oracle18CPDBCatalogerTagsConfig.json | $.Filter7 | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Get          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               |                                                                                                         |           | 200           | OracleDBCataloger |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger  |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBCataloger')].status |
      | IDC         | TestSystemUser | application/json |       |       | Post         | extensions/analyzers/start/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger   |                                                                                                         |           | 200           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger  |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBCataloger')].status |
      | IDC         | TestSystemUser | application/json |       |       | Put          | settings/analyzers/OracleDBAnalyzer/OracleDBAnalyzer                                 | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/Oracle18CPDBAnalyzerTagsConfig.json  | $.Filter7 | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Get          | settings/analyzers/OracleDBAnalyzer/OracleDBAnalyzer                                 |                                                                                                         |           | 200           | OracleDBAnalyzer  |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBAnalyzer')].status  |
      | IDC         | TestSystemUser | application/json |       |       | Post         | extensions/analyzers/start/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer  |                                                                                                         |           | 200           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBAnalyzer')].status  |
  ...
  (Ex: 0.2 - 2 or more rows should have matcning column values - namePattern,typePattern,dataPattern and minimumRatio passed).
    ...
    Then user "verify tag item non presence" of technology tags for the below Type and file names
      | catalogName | name              | facet | Tag       | fileName | userTag                                   |
      | Default     | Orc18cPDBAnalyzer | Tags  | FullMatch | COMMENTS | TAGDETAILS_Ratiolesserthan05MatchFullTrue |
  ...
  Scenario Outline:SC#46_4_Create OracleDB Plugin config and start it
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                                  | bodyFile                                                                                                | path      | response code | response message  | jsonPath                                               |
      | IDC         | TestSystemUser | application/json |       |       | Put          | policy/tagging/actions                                                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/policyEngine/OracleDBTag.json                            | $.SC48_1  | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBAnalyzer')].status  |
      | IDC         | TestSystemUser | application/json |       |       | Post         | extensions/analyzers/start/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer  |                                                                                                         |           | 200           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBAnalyzer')].status  |
  ...
  (Ex: 0.2 - 2 or more rows should have matching column values - namePattern,typePattern,dataPattern and minimumRatio passed).
    ...
    Then user "verify tag item presence" of technology tags for the below Type and file names
      | catalogName | name              | facet | Tag                                                                                      | fileName | userTag                                   |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,FullMatch | COMMENTS | TAGDETAILS_Ratiolesserthan05MatchFullTrue |
  ...
  Scenario Outline:SC#47_1_Create OracleDB Plugin config and start it
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                                  | bodyFile                                                                                                | path      | response code | response message  | jsonPath                                               |
      | IDC         | TestSystemUser | application/json |       |       | Put          | policy/tagging/actions                                                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/policyEngine/OracleDBTag.json                            | $.SC49    | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Put          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/Oracle18CPDBCatalogerTagsConfig.json | $.Filter8 | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Get          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               |                                                                                                         |           | 200           | OracleDBCataloger |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger  |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBCataloger')].status |
      | IDC         | TestSystemUser | application/json |       |       | Post         | extensions/analyzers/start/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger   |                                                                                                         |           | 200           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger  |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBCataloger')].status |
      | IDC         | TestSystemUser | application/json |       |       | Put          | settings/analyzers/OracleDBAnalyzer/OracleDBAnalyzer                                 | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/Oracle18CPDBAnalyzerTagsConfig.json  | $.Filter8 | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Get          | settings/analyzers/OracleDBAnalyzer/OracleDBAnalyzer                                 |                                                                                                         |           | 200           | OracleDBAnalyzer  |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBAnalyzer')].status  |
      | IDC         | TestSystemUser | application/json |       |       | Post         | extensions/analyzers/start/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer  |                                                                                                         |           | 200           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBAnalyzer')].status  |
  ...
  (Ex: 0.6 - 6 or more rows should have matcning column values including empty) - Match Empty is False -10 rows , 3 rows empty, 4 rows match,3 rows does not match
    ...
    Then user "verify tag item presence" of technology tags for the below Type and file names
      | catalogName | name              | facet | Tag                                                                                          | fileName  | userTag         |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,Email Address | EMAIL     | TAGDETAILS_VIEW |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,IP Address    | IPADDRESS | TAGDETAILS_VIEW |
  ...
  Scenario Outline:SC#48_1_Create OracleDB Plugin config and start it
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                                  | bodyFile                                                                                                | path      | response code | response message  | jsonPath                                               |
      | IDC         | TestSystemUser | application/json |       |       | Put          | policy/tagging/actions                                                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/policyEngine/OracleDBTag.json                            | $.SC50    | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Put          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/Oracle18CPDBCatalogerTagsConfig.json | $.Filter8 | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Get          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               |                                                                                                         |           | 200           | OracleDBCataloger |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger  |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBCataloger')].status |
      | IDC         | TestSystemUser | application/json |       |       | Post         | extensions/analyzers/start/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger   |                                                                                                         |           | 200           |                   |                                                        |
  ...
  (Ex: 0.6 - 6 or more rows should have matcning column values including empty) - Match Empty is True -10 rows , 3 rows empty, 4 rows match,3 rows does not match
    ...
    Then user "verify tag item presence" of technology tags for the below Type and file names
      | catalogName | name              | facet | Tag                                                                                          | fileName  | userTag         |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,Email Address | EMAIL     | TAGDETAILS_VIEW |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,Gender        | GENDER    | TAGDETAILS_VIEW |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,IP Address    | IPADDRESS | TAGDETAILS_VIEW |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,SSN           | SSN       | TAGDETAILS_VIEW |
      | Default     | Orc18cPDBAnalyzer | Tags  | Orc18cPDBAnalyzer,Oracle,Orc18cPDBCataloger,Oracle18C_PDB_Cat,Oracle18C_PDB_AY,Full Name     | FULL_NAME | TAGDETAILS_VIEW |
  ...
  Scenario Outline:SC#49_1_Create OracleDB Plugin config and start it
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                                  | bodyFile                                                                                                | path      | response code | response message  | jsonPath                                               |
      | IDC         | TestSystemUser | application/json |       |       | Put          | policy/tagging/actions                                                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/policyEngine/OracleDBTag.json                            | $.SC51    | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Put          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/Oracle18CPDBCatalogerTagsConfig.json | $.Filter2 | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Get          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               |                                                                                                         |           | 200           | OracleDBCataloger |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger  |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBCataloger')].status |
      | IDC         | TestSystemUser | application/json |       |       | Post         | extensions/analyzers/start/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger   |                                                                                                         |           | 200           |                   |                                                        |
  ...
  Scenario Outline:SC#50_1_Create OracleDB Plugin config and start it
    ...
    Examples:
      | ServiceName | ServiceUser    | Header           | Query | Param | type         | url                                                                                  | bodyFile                                                                                                | path      | response code | response message  | jsonPath                                               |
      | IDC         | TestSystemUser | application/json |       |       | Put          | policy/tagging/actions                                                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/policyEngine/OracleDBTag.json                            | $.SC52    | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Put          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               | payloads/ida/jdbcAnalyzerPayloads/Oracle18cPDB/pluginConfiguration/Oracle18CPDBCatalogerTagsConfig.json | $.Filter2 | 204           |                   |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | Get          | settings/analyzers/OracleDBCataloger/OracleDBCataloger                               |                                                                                                         |           | 200           | OracleDBCataloger |                                                        |
      | IDC         | TestSystemUser | application/json |       |       | RecursiveGet | extensions/analyzers/status/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger  |                                                                                                         |           | 200           | IDLE              | $.[?(@.configurationName=='OracleDBCataloger')].status |
      | IDC         | TestSystemUser | application/json |       |       | Post         | extensions/analyzers/start/LocalNode/cataloger/OracleDBCataloger/OracleDBCataloger   |                                                                                                         |           | 200           |                   |                                                        |
  ...
  Scenario:SC#50_3_Delete Cluster , Cataloger and Analyzer Analysis file
    Given Delete multiple values in IDC UI with below parameters
      ...
      | SingleItemDelete | Default | cataloger/OracleDBCataloger/OracleDBCataloger%  | Analysis            |       |       |
      | SingleItemDelete | Default | dataanalyzer/OracleDBAnalyzer/OracleDBAnalyzer% | Analysis            |       |       |
      | SingleItemDelete | Default | Oracle18C_PDB_Cat                               | BusinessApplication |       |       |
      | SingleItemDelete | Default | Oracle18C_PDB_AY                                | BusinessApplication |       |       |
...
#      | IDC         | TestSystemUser | application/json | raw   | false | Delete | settings/analyzers/EDIBusDataSource                 |      | 204           |                  |          |
      | IDC         | TestSystemUser | application/json | raw   | false | Delete | settings/credentials/Oracle18cPDBCredentials        |      | 200           |                  |          |
      | IDC         | TestSystemUser | application/json | raw   | false | Delete | settings/credentials/Oracle18cPDBInvalidCredentials |      | 200           |                  |          |
      | IDC         | TestSystemUser | application/json | raw   | false | Delete | settings/credentials/Oracle18cPDBEmptyCredentials   |      | 200           |                  |          |
