Feature: MLP-8161 Message Improvements with standard license
  ...
  Scenario:SC2# MLP-8161 Verification of error code EDIBUS-E0006
    ...
    Then Analysis log "bulk/EDIBus/Error0006%" should display below info/error/warning
      | type  | logValue                                                                             | logCode      |
      | ERROR | Access to EDI server usyp5thirmoga1v.asg.com at port 9,292 denied for user ADMINTEST | EDIBUS-E0103 |
...
#      | Table | value | Action               | RetainPrevwindow | indexSwitch |
#      | Data  | log   | click and switch tab | No               |             |
#    And Analysis log "bulk/EDIBus/Error0059toEDI%" should display below info/error/warning
#      | type  | logValue                                               | logCode      |
