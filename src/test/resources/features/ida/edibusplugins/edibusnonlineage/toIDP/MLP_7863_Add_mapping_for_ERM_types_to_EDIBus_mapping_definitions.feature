Feature: MLP-7863 Add mapping for ERM types to EDIBus mapping definitions with Standard License
...
##6478517##
  ...
  Scenario:SC2#:Delete the analysis item
   ...
   ##6478871##
  @edibus @mlp-7863 @webtest @positive @toIDP
  Scenario:SC3#MLP-7863_Verification of adding ERM item types from EDI to IDP incremental replication
    Given Execute REST API with following parameters
      | Header           | Query | Param | type         | url                                                          | body                                    | response code | response message | jsonPath                                     |
...
#Attribute verification has been covered in MLP-26233
###6563763##
