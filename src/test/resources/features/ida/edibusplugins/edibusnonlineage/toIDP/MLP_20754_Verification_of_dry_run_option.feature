Feature: MLP-20754 Feature for verification of dry run with standard license
  ...
  Scenario Outline:SC1#MLP-20754_Verification of dry run option from EDI to IDX
    ...
    And Analysis log "bulk/EDIBus/EDItoIDXDryRun%" should display below info/error/warning
      ...
      | INFO | Plugin EDIBus processed 16 items on dry run mode and not written to the repository                                                                    | ANALYSIS-0070 |            |               |
      | INFO | The replication in dryRun mode processed 16 items in 1 cycles and took 1s; 19 items would be written and 0 items would be deleted in the IDC catalog. | EDIBUS-I0021  |            |               |
...
#      | type | logValue                                                                                                                       | logCode       | pluginName | removableText |
#      | INFO | Plugin EDIBus running on dry run mode                                                                                          | ANALYSIS-0069 |            |               |
#      | INFO | Plugin EDIBus processed 33 items on dry run mode and not written to the repository                                             | ANALYSIS-0070 |            |               |
#      | INFO | The replication in dryRun mode read 29 items in 1 cycles in 0s; 33 items would be written and 0 items would be deleted in EDI. | EDIBUS-I0044  |            |               |
