#Feature: MLP_7615_Verification_of_linking_column
...
#      | Lineage Hops | NewTransformationMap | click and switch tab | No               |             |
#    Then user performs click and verify in new window
#      | Table          | value | Action                 | RetainPrevwindow | indexSwitch |
#      | Lineage Source | Col1  | verify widget contains | No               |             |
#      | Lineage Target | Col2  | verify widget contains | No               |             |
#
#
