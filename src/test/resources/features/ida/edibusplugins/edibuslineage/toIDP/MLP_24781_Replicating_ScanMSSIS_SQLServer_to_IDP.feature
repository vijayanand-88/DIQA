Feature: MLP_24781 Replicate ScanMSSIS and MS SQL Server technologies to IDP
  ...
  Scenario:SC1#MLP-24781 Verification of replication of MS SQL Server technology from EDI to DD
    ...
    And Analysis log "bulk/EDIBus/SQLtoIDP%" should display below info/error/warning
      ...
      | INFO | replication of 5963 items | EDIBUS-I0024 |            |               |
  ...
  Scenario Outline:SC2#MLP-24781 Verification of deleting the replicated MS SQL Server items using toIDPCleanup
    ...
    And Analysis log "bulk/EDIBus/SQLtoIDP%" should display below info/error/warning
      | type | logValue           | logCode      | pluginName | removableText |
      | INFO | 6105 items deleted | EDIBUS-I0010 |            |               |
  ...
  Scenario:SC5#MLP-24781 Verification of replication of ScanMSSIS technology from EDI to DD
    ...
    And Analysis log "bulk/EDIBus/MSSIStoIDP%" should display below info/error/warning
      | type | logValue                  | logCode      | pluginName | removableText |
      | INFO | replication of 1111 items | EDIBUS-I0024 |            |               |
    ...
    Then user performs click and verify in new window
      | Table          | value                | Action                 | RetainPrevwindow | indexSwitch |
      | Lineage Hops   | collection_time      | verify widget contains | No               |             |
      | Lineage Hops   | snapshot_id          | verify widget contains | No               |             |
      | Lineage Hops   | collect_time_convert | click and switch tab   | No               |             |
      | Lineage Source | collection_time      | verify widget contains | No               |             |
      | Lineage Target | collect_time_convert | verify widget contains | No               |             |
