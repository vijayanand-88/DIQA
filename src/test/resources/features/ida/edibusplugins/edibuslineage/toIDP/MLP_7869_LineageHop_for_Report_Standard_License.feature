Feature: MLP-7869 LineageHops in IDP for lineage relevant link relationships in EDI

##6363767#bug id:28136#
  ...
  Scenario:MLP-7869_verification of Lineage hop for Report for the items replicated from EDI to IDP
    ...
    Then user performs click and verify in new window
      ...
      | Lineage Hops | TESTGC-REPORT1 | click and switch tab | No               |             |
    Then user performs click and verify in new window
      | Table          | value            | Action                 | RetainPrevwindow | indexSwitch |
      | Lineage Source | ORGANIZATION_KEY | verify widget contains | No               |             |
      | Lineage Source | TESTGG-FIELD1    | verify widget contains | No               |             |
      | Lineage Target | TESTGC-REPORT1   | verify widget contains | No               |             |


    ##6363891#bug id:28136#
  ...
  Scenario:MLP-7864 Verification of replicating stitching items in incremental mode  from EDI to IDP
    ...
    Then user performs click and verify in new window
      | Table        | value            | Action               | RetainPrevwindow | indexSwitch |
      | Lineage Hops | ORGANIZATION_KEY | click and switch tab | No               |             |
    Then user performs click and verify in new window
      | Table        | value            | Action                 | RetainPrevwindow | indexSwitch |
      | Lineage Up   | ORGANIZATION_KEY | verify widget contains | No               |             |
      | Lineage Down | ORGANIZATION_KEY | verify widget contains | No               |             |
