@MLP-1304
Feature: MLP-1304: As a User I want to see properties of source tree.
  ...
  Information area, which is defined by source tree without error details

  @MLP-1304 @webtest @positive
  Scenario:MLP-1304: Verify the source tree properties are displayed on detail view panel.
    ...
    Then items list page should open with pagination and source tree properties should not have error
  ...
  Scenario:MLP-1304: Verify the source tree properties are displayed on detail view panel.
    ...
    When user clicks on Analysis widget title link in the dashboard page
    And user clicks on quicklink report on the Analysis Subject Area Structure page
    And user clicks on file with deprecated pythin syntax mentioned in json config file from quick link page
    And user clicks on source tree of file mentioned in json config file from the item list page.
    Then items list page should open with pagination and source tree properties should not have error
    And user clicks on close button in the item full view page
    And user should be able logoff the IDC