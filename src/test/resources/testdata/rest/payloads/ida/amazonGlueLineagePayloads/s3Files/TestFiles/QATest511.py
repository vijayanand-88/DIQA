...
true_company_op = glueContext.write_dynamic_frame.from_options(frame=true_company, connection_type="s3",
                                                               connection_options={
                                                                   "path": "s3://asgqatestautomation4/TargetFiles/Target511/TrueCompany"},
                                                               format="csv", transformation_ctx="true_company_op")

fruits_and_comp1_op = glueContext.write_dynamic_frame.from_options(frame=fruits_and_comp1, connection_type="s3",
                                                              connection_options={
