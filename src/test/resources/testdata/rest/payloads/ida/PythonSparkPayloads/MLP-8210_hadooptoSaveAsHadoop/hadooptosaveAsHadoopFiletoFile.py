...
def basic_datasource_example1(sc):
  ...
  lines.saveAsHadoopFile("hdfs:///python/Target/hadoopfile_to_saveasHadoopformat","org.apache.hadoop.mapred.TextOutputFormat","org.apache.hadoop.io.compress.GzipCodec")
