...
def jdbc_oracle_example1(spark):
       ...
       oracleDF.write.jdbc("jdbc:oracle:thin:@DIDORACLE01V.DID.DEV.ASGINT.LOC:1521:ORACLE12C", "COLLECTOR.UPPERSALARYPEOPLES_NOSELECT",properties={"user": "testuser", "password": "admin345","driver": "oracle.jdbc.driver.OracleDriver"})
