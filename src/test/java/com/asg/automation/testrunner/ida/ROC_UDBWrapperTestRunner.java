...
@CucumberOptions(
        features = {
                "src/test/resources/features/ida/rochadescanners/ROC_UDBScript.feature",
                "src/test/resources/features/ida/rochadescanners/ROC_UDBScan.feature"
        },
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})


public class ROC_UDBWrapperTestRunner extends AbstractTestNGCucumberTests {
