...
@CucumberOptions(
        features = {"src/test/resources/features/ida/javaplugins/JavaSparkSnowflake.feature",
                "src/test/resources/features/javaplugins/JavaSparkSQL.feature"},
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})


public class JavaSparkLineage_Snowflake_SQL_TestRunner extends AbstractTestNGCucumberTests {
