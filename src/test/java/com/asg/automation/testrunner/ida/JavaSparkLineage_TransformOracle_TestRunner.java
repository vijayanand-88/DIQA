...
@CucumberOptions(
        features = {"src/test/resources/features/ida/javaplugins/JavaSparkLineageTransformation.feature"},
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})


public class JavaSparkLineage_TransformOracle_TestRunner extends AbstractTestNGCucumberTests {
