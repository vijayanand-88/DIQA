...
@CucumberOptions(
        features = {
                "src/test/resources/features/ida/rochadescanners/ROC_Oracle19C_PDB_CDB.feature",
                "src/test/resources/features/ida/rochadescanners/ROC_OracleScript19C_PDB_CDB.feature"
        },
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})


public class ROC_OracleWrapperTestRunner extends AbstractTestNGCucumberTests {
