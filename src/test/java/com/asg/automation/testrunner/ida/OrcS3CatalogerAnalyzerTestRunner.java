...
@CucumberOptions(
        features = {"src/test/resources/features/ida/awsplugins/OrcS3_Cataloger.feature",
                "src/test/resources/features/ida/awsplugins/OrcS3_Analyzer.feature"},
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})



public class OrcS3CatalogerAnalyzerTestRunner extends AbstractTestNGCucumberTests {
