...
@CucumberOptions(
        features = {"src/test/resources/features/ida/awsplugins/DynamoDB_Cataloger_Analyzer.feature"},
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})
public class DynamoDBTestRunner extends AbstractTestNGCucumberTests {
