...
/**
 * Created by Karthik on 07/30/2019
 */

@CucumberOptions(
        features = {"src/test/resources/features/ida/javaplugins/JavaIOLinker.feature"},
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})
public class JavaLinkerTestRunner extends AbstractTestNGCucumberTests {
