...
@CucumberOptions(
        features = {"src/test/resources/features/ida/pythonplugins/Spark_lineage_Oracle_Transformation.feature"},
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})
public class PythonSparkTestRunner_Transformation_9174 extends AbstractTestNGCucumberTests {
