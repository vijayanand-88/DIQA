...
@CucumberOptions(
        features = {"src/test/resources/features/ida/rochadescanners/ROC_SQLServerScript.feature"},
//              features = {"src/test/resources/features/ida/XRAY/xrayimportfeature.feature"},
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})


public class ROC_SQLServerScriptWrapperTestRunner extends AbstractTestNGCucumberTests {
