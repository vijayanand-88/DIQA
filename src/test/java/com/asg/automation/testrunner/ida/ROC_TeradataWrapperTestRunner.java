...
@CucumberOptions(
        features = {
                "src/test/resources/features/ida/rochadescanners/ROC_Teradata_v16.feature",
                "src/test/resources/features/ida/rochadescanners/ROC_TeradataScript.feature"
        },
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})


public class ROC_TeradataWrapperTestRunner extends AbstractTestNGCucumberTests {
