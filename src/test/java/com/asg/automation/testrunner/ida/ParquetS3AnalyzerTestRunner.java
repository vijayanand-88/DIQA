...
@CucumberOptions(
        features = {"src/test/resources/features/ida/awsplugins/ParquetS3_Analyzer.feature"},
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})



public class ParquetS3AnalyzerTestRunner extends AbstractTestNGCucumberTests {
