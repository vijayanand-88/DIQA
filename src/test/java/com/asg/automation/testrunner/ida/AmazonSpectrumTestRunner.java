...
@CucumberOptions(
        features = {
                "src/test/resources/features/ida/awsplugins/AmazonSpectrum.feature",
                "src/test/resources/features/ida/awsplugins/AmazonSpectrumLineage.feature",
                "src/test/resources/features/ida/awsplugins/AmazonSpectrumIncremetalCases.feature"
        },
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})

public class AmazonSpectrumTestRunner extends AbstractTestNGCucumberTests {
