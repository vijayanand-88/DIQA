...
@CucumberOptions(
        features = {"src/test/resources/features/ida/rochadescanners/ROC_SqlServerAnalyzer2019.feature"},
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})
public class ROC_SqlserverAnalyzer extends AbstractTestNGCucumberTests {
