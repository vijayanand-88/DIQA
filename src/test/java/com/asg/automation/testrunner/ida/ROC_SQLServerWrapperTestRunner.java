...
@CucumberOptions(
//        features = {"src/test/resources/features/ida/rochadescanners/ROC_SQLServer.feature"},
        features = {"src/test/resources/features/ida/XRAY/ROC_SQLServer.feature"},
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})


public class ROC_SQLServerWrapperTestRunner extends AbstractTestNGCucumberTests {
