...
/**
 * Created by Chella M on 07/07/2020.
 */

@CucumberOptions(
        features = {
                "src/test/resources/features/ida/jdbcplugins/sqldb/JDBCAnalyzerOracle_19C_PDB_CDB_PostProcessor.feature",
                "src/test/resources/features/ida/jdbcplugins/sqldb/JDBCAnalyzerOracle_19C_RDS_PostProcessor.feature"
        },
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})
public class JDBCOracle19CLineageTestRunner extends AbstractTestNGCucumberTests {
