...
@CucumberOptions(
        features = {"src/test/resources/features/ida/awsplugins/AmazonRedShift.feature",
                "src/test/resources/features/ida/awsplugins/AmazonRedShiftPostProcessor.feature"
        },
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})


public class AmazonRedshift extends AbstractTestNGCucumberTests {
