...
@CucumberOptions(
        features = {"src/test/resources/features/ida/javaplugins/JavaJDBCLineageOracle.feature"},
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})


public class JavaJDBCLineage_Oracle_TestRunner extends AbstractTestNGCucumberTests {
