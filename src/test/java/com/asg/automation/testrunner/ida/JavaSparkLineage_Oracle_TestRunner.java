...
@CucumberOptions(
        features = {"src/test/resources/features/ida/javaplugins/JavaSparkOracle.feature"},
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})


public class JavaSparkLineage_Oracle_TestRunner extends AbstractTestNGCucumberTests {
