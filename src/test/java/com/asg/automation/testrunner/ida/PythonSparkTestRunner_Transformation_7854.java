 ...
 */
    ...
    @CucumberOptions(
            features = {"src/test/resources/features/ida/pythonplugins/Spark_lineage_Oracle.feature"},
            glue = {"com.asg.automation.stepdefinition"},
            plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})
    public class PythonSparkTestRunner_Transformation_7854 extends AbstractTestNGCucumberTests {
