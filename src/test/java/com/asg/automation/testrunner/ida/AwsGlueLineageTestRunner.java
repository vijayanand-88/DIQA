...
/**
 * Created by Karthik on 03/14/2019
 */

@CucumberOptions(
        features = {"src/test/resources/features/ida/awsplugins/AmazonGlueLineage.feature"},
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})
public class AwsGlueLineageTestRunner extends AbstractTestNGCucumberTests {
