...
/**
 * Created by Karthik on 07/11/2019
 */

@CucumberOptions(
        features = {"src/test/resources/features/ida/javaplugins/JavaParserLocalNode.feature","src/test/resources/features/ida/javaplugins/JavaParserInternalNode.feature"},
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})

public class JavaParserTestRunner extends AbstractTestNGCucumberTests {
