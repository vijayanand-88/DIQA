...
@CucumberOptions(
        features = {"src/test/resources/features/ida/rochadescanners/ROC_OracleAnalyzer19c_PDB.feature"},
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})
public class ROC_OracleAnalyzer19c_PDB extends AbstractTestNGCucumberTests {
