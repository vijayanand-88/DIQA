...
/**
 * Created by Thangamalar Saranya on 13/06/2019.
 */

@CucumberOptions(
        features = {"src/test/resources/features/ida/azureplugins/AzureCosmosCataloger_Mongo.feature",
                "src/test/resources/features/ida/azureplugins/AzureCosmosCataloger_SQL.feature"},
        glue = {"com.asg.automation.stepdefinition"},
        format = {"pretty", "html:target/cucumber-html-report", "pretty:target/cucumber-report.json"})

public class AzureCosmosTestRunner extends AbstractTestNGCucumberTests {
