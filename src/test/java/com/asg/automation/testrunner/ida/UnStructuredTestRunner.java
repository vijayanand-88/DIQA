...
@CucumberOptions(
        features = {"src/test/resources/features/ida/externalplugins/unstructured/Unstructured.feature"},
        glue = {"com.asg.automation.stepdefinition"},
        format = {"pretty", "html:target/cucumber-html-report", "pretty:target/cucumber-report.json"})



public class UnStructuredTestRunner extends AbstractTestNGCucumberTests {
