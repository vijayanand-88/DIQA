...
/**
 * Created by Karthik on 08/11/2019
 */

@CucumberOptions(
        features = {"src/test/resources/features/ida/javaplugins/JavaRedShiftLineage_CSV.feature","src/test/resources/features/ida/javaplugins/JavaRedShiftLineage_JSON.feature"},
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})
public class JavaRedshiftLineageTestRunner extends AbstractTestNGCucumberTests {
