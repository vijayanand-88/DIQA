...
@CucumberOptions(
        features = {"src/test/resources/features/ida/caeintegration/zOSPDSCollector.feature","src/test/resources/features/ida/caeintegration/CAE_zOS_DB2.feature"},
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})

public class CAEZOSCollectorRunner extends AbstractTestNGCucumberTests {
