...
/**
 * Created by Jayasree on 03/25/202.
 */

    @CucumberOptions(
            features = {"src/test/resources/features/ida/pythonplugins/Spark_lineage_Amazon S3.feature"},
            glue = {"com.asg.automation.stepdefinition"},
            format = {"pretty", "html:target/cucumber-html-report", "pretty:target/cucumber-report.json"})
    public class AmazonS3_PythonSparkTestRunner_8132 extends AbstractTestNGCucumberTests {
