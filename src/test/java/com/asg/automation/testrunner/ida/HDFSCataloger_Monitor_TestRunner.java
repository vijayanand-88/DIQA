 ...
 */
    ...
    @CucumberOptions(
            features = {"src/test/resources/features/ida/bigdataplugins/01_Hdfs_Cataloger.feature",
                    "src/test/resources/features/ida/bigdataplugins/02_Hdfs_Monitor.feature"},
            glue = {"com.asg.automation.stepdefinition"},
            plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})
    public class HDFSCataloger_Monitor_TestRunner extends AbstractTestNGCucumberTests {
