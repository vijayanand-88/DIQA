...
@CucumberOptions(
        features = {
                "src/test/resources/features/ida/bigdataplugins/HiveCatalogerWithDataSource.feature",
...
public class HiveCataloger_And_HiveMonitor extends AbstractTestNGCucumberTests {
