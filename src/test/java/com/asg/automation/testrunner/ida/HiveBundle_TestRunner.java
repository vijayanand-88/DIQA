 ...
 */
    ...
    @CucumberOptions(
            features = { "src/test/resources/features/ida/bigdataplugins/HiveCatalogerWithDataSource.feature",
                    "src/test/resources/features/ida/bigdataplugins/HiveAnalyzer.feature",
                    "src/test/resources/features/ida/bigdataplugins/HiveMonitor.feature",
                    "src/test/resources/features/ida/bigdataplugins/HiveQueryParser.feature"},
            glue = {"com.asg.automation.stepdefinition"},
            plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})
    public class HiveBundle_TestRunner extends AbstractTestNGCucumberTests {
