...
@CucumberOptions(
        features = {"src/test/resources/features/ida/caeintegration/CAE_Git_Collector.feature", "src/test/resources/features/ida/caeintegration/SVNCollector.feature", "src/test/resources/features/ida/caeintegration/TFSCollector.feature"},
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})

public class CAESCMSCollectorRunner extends AbstractTestNGCucumberTests {
