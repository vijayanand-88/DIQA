...
/**
 * Created by Jayasree M on 11/18/2020.
 */

@CucumberOptions(
        features = {"src/test/resources/features/ida/caeintegration/CAE_SqlServerAnalyzer2019.feature"
        },
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})


public class CAESqlServerAnalyzerTestRunner extends AbstractTestNGCucumberTests {
