...
@CucumberOptions(
        features = {
                "src/test/resources/features/ida/jdbcplugins/sqldb/JDBCAnalyzerOracle_18c_PDB.feature",
                "src/test/resources/features/ida/jdbcplugins/sqldb/JDBCAnalyzerOracle_18c_CDB.feature",
                "src/test/resources/features/ida/jdbcplugins/sqldb/JDBCAnalyzerOracle_18C_PDB_CDB_RDS_PostProcessor.feature"
        },
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})
public class JDBCOracle18cTestRunner extends AbstractTestNGCucumberTests {
