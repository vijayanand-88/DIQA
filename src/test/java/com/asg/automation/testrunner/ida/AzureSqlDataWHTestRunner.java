...
/**
 * Created by Thangamalar Saranya on 21/06/2019.
 */

@CucumberOptions(
        features = {"src/test/resources/features/ida/azureplugins/JDBC_AzureSQLDataWarehouse.feature"},
        glue = {"com.asg.automation.stepdefinition"},
        format = {"pretty", "html:target/cucumber-html-report", "pretty:target/cucumber-report.json"})

public class AzureSqlDataWHTestRunner extends AbstractTestNGCucumberTests {
