 ...
 */
    ...
    @CucumberOptions(
            features = {"src/test/resources/features/ida/pythonplugins/Spark_lineage_Redshift.feature"},
            glue = {"com.asg.automation.stepdefinition"},
            format = {"pretty", "html:target/cucumber-html-report", "pretty:target/cucumber-report.json"})
    public class AmazonRedshift_PythonSparkTestRunner_7855 extends AbstractTestNGCucumberTests {
