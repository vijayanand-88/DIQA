...
@CucumberOptions(
        features = {"src/test/resources/features/ida/caeintegration/UDBCollector.feature"
        },
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})


public class CAEUDBCollectorTestRunner extends AbstractTestNGCucumberTests {
