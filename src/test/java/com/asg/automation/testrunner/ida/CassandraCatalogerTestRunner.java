 ...
 */
    ...
    @CucumberOptions(
            features = {"src/test/resources/features/ida/jdbcplugins/nosqldb/Cassandra_DB_Cataloger.feature"},
            glue = {"com.asg.automation.stepdefinition"},
            plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})

    public class CassandraCatalogerTestRunner extends AbstractTestNGCucumberTests {
