...
/**
 * Created by Karthik on 09/08/2019
 */

@CucumberOptions(
        features = {"src/test/resources/features/ida/javaplugins/JavaS3Lineage.feature"},
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})
public class JavaS3LineageTestRunner extends AbstractTestNGCucumberTests {
