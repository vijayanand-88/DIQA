...
/**
 * Created by gokul on 04/16/2020
 */

@CucumberOptions(
        features = {"src/test/resources/features/ida/javaplugins/JavaIOLineage.feature"},
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})
public class JavaIOLineageTestRunner extends AbstractTestNGCucumberTests {
