...
/**
 * Created by Jayasree on 04/8/2020.
 */

    @CucumberOptions(
            features = {"src/test/resources/features/ida/javaplugins/JavaSparkAmazonRedshift.feature"},
            glue = {"com.asg.automation.stepdefinition"},
            plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})
    public class JavaSparkTestRunner_Redshift extends AbstractTestNGCucumberTests {
