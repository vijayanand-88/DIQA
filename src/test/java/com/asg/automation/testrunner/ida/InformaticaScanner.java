...
/**
 * Created by Jayasree on 02/11/2020.
 */

@CucumberOptions(
        features = {"src/test/resources/features/ida/caeintegration/Informatica_Scanner.feature"
        },
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})


public class InformaticaScanner extends AbstractTestNGCucumberTests {
