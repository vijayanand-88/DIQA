...
@CucumberOptions(
        features = {
                "src/test/resources/features/ida/jdbcplugins/sqldb/SqlServerCatalogerAnalyzer2019_RDS.feature",
                "src/test/resources/features/ida/jdbcplugins/sqldb/SqlServerCatalogerAnalyzer_RDS.feature",
                "src/test/resources/features/ida/jdbcplugins/sqldb/SqlServerCatalogerAnalyzer_OnPrem.feature"
        },
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})


public class SqlServerTestRunner extends AbstractTestNGCucumberTests {
