...
@CucumberOptions(
        features = {"src/test/resources/features/ida/awsplugins/JSONS3_Cataloger.feature"},
        glue = {"com.asg.automation.stepdefinition"},
        plugin = {"json:target/cucumber.json", "html:target/cucumber-html-reports"})



public class JsonS3CatalogerTestRunner extends AbstractTestNGCucumberTests {
